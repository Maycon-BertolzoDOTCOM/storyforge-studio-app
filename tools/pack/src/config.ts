...
import { resolveNamespace } from "@storyforge-app/sidecar";
import { releaseChannelFromVersion, releaseNamespace } from "@storyforge-app/release";
...
export type ToolPackConfig = {
   ...
   * at packaging time. Baked into storyforge-config.json so the packaged
  ...
  /**
   * PostHog project ID (e.g. `420348` for the official StoryForge project)
