...
const BUILD_COMMANDS = [
  { args: ["--filter", "@storyforge-app/release", "build"] },
  { args: ["--filter", "@storyforge-app/components", "build"] },
  { args: ["--filter", "@storyforge-app/contracts", "build"] },
  { args: ["--filter", "@storyforge-app/registry-protocol", "build"] },
  { args: ["--filter", "@storyforge-app/sidecar-proto", "build"] },
  { args: ["--filter", "@storyforge-app/launcher-proto", "build"] },
  { args: ["--filter", "@storyforge-app/sidecar", "build"] },
  { args: ["--filter", "@storyforge-app/platform", "build"] },
  { args: ["--filter", "@storyforge-app/download", "build"] },
  { args: ["--filter", "@storyforge-app/host", "build"] },
  { args: ["--filter", "@storyforge-app/agui-adapter", "build"] },
  { args: ["--filter", "@storyforge-app/plugin-runtime", "build"] },
  { args: ["--filter", "@storyforge-app/diagnostics", "build"] },
  { args: ["--filter", "@storyforge-app/daemon", "build"] },
  { args: ["--filter", "@storyforge-app/web", "build"], env: ["OD_WEB_OUTPUT_MODE"] },
  { args: ["--filter", "@storyforge-app/web", "build:sidecar"] },
  { args: ["--filter", "@storyforge-app/desktop", "build"] },
  { args: ["--filter", "@storyforge-app/packaged", "build"] },
] as const;
