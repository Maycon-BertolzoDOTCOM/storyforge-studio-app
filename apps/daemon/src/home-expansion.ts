 ...
 * $HOME/.storyforge lands every daemon write at the same expanded path.
 *
 ...
 * prefix so a Windows launcher passing $HOME\.storyforge behaves the same
 * as a Unix launcher passing $HOME/.storyforge; the result is rebuilt via
