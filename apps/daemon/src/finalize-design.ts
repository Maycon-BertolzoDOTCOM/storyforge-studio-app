...
// tsconfig does not resolve the `@storyforge-app/contracts/api/chat` subpath
...
} from '@storyforge-app/contracts/api/finalize';
...
// canonical definitions live in @storyforge-app/contracts/api/finalize
