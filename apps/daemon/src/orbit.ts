...
import type { OrbitRunSummary, OrbitStatusResponse } from '@storyforge-app/contracts/api/orbit';
...
export function buildOrbitSystemPrompt(
  ...
  const lines = [
    ...
    '- Code: “storyforge had 4 repositories updated. The most notable change was a daemon update that affects data refresh behavior, so review it before the next release.”',
