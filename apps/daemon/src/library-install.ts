...
// Installed items live under ~/.storyforge/skills/ and
// ~/.storyforge/design-systems/ respectively.
 ...
 * @param {string} userDir - user-installed directory (e.g. ~/.storyforge/skills)
