...
// REASONIX_ACP_SYSTEM_APPEND. This ensures the model follows StoryForge's
// design workflow (artifact output, design system, skill instructions)
// instead of treating every request as a pure coding task.
const DESIGN_INSTRUCTIONS = `# StoryForge integration — MUST follow

You are running inside StoryForge, a design tool. The user message contains
