...
//
//   - `od`            → SKILL.md + storyforge.json (canonical OD shape).
...
// installed plugin's fs_path, and reconstructs storyforge.json from
...
import type { AppliedPluginSnapshot } from '@storyforge-app/contracts';
