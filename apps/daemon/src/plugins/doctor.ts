...
//
//   - Validates the manifest using @storyforge-app/plugin-runtime's validateSafe.
...
import { manifestSourceDigest, resolveContext, validateSafe, type RegistryView } from '@storyforge-app/plugin-runtime';
import type { InstalledPluginRecord, PluginManifest } from '@storyforge-app/contracts';
