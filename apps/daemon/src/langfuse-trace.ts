...
// official StoryForge telemetry relay or, for local smoke tests, directly to
...
export interface RuntimeInfo {
  ...
  arch?: string;
  /** StoryForge app version reported by the daemon. */
  appVersion?: string;
...
function buildTagList(ctx: ReportContext): string[] {
  const tags = ['storyforge', `project:${ctx.projectId}`];
