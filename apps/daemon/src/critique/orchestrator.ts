...
import type { CritiqueConfig, PanelEvent } from '@storyforge-app/contracts/critique';
import { panelEventToSse } from '@storyforge-app/contracts/critique';
import type { CritiqueSseEvent } from '@storyforge-app/contracts/critique';
...
const tracer = trace.getTracer('@storyforge-app/daemon/critique');
