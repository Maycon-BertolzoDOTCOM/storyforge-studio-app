...
// Locations:
//
//   packaged (mac):    ~/Library/Application Support/StoryForge Prerelease/installation.json
//   packaged (win):    %APPDATA%/StoryForge Prerelease/installation.json
//   packaged (linux):  $XDG_CONFIG_HOME/StoryForge Prerelease/installation.json
