  ...
  it('maps document refresh data paths directly even when a legacy transform is present', () => {
    const document: any = {
      ...
      sourceJson: {
        ...
        input: { url: 'https://api.github.com/repos/nexu-io/storyforge' },
        outputMapping: {
          dataPaths: [
    ...
    const candidate = buildLiveArtifactRefreshCandidate({
      ...
      documentOutput: {
        output: {
          ...
          full_name: 'nexu-io/storyforge',
          html_url: 'https://github.com/nexu-io/storyforge',
