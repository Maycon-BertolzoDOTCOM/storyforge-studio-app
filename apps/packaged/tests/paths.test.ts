...
function fakeConfig(): PackagedConfig {
  return {
    ...
    namespaceBaseRoot: join("C:", "Users", "Fred", "AppData", "Roaming", "StoryForge", "namespaces"),
    nodeCommand: null,
    posthogHost: null,
    posthogKey: null,
    resourceRoot: join("C:", "Program Files", "StoryForge", "resources", "storyforge"),
...
describe("resolvePackagedNamespacePaths", () => {
  ...
  it("rejects namespace overrides that would escape the namespace base root", () => {
    const config: PackagedConfig = {
      ...
      daemonSidecarEntry: null,
      namespace: "release",
      namespaceBaseRoot: "/tmp/storyforge-packaged/namespaces",
      nodeCommand: null,
      resourceRoot: "/tmp/storyforge-packaged/resources",
      telemetryRelayUrl: null,
      updateMetadataUrl: null,
      posthogKey: null,
      posthogHost: null,
