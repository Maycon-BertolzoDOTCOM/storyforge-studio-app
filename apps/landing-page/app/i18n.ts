...
export interface HeaderCopy {
  ...
  starTitle: string;
  starPrefix: string;
  /** StoryForge Cloud account entry — see header-enhancer.astro. */
  signIn: string;
...
export interface HeaderProductMenuCopy {
  ...
  // nouns in the markup; everything below mirrors the live storyforge.ai
...
const COMMON_COPY: Record<LandingLocaleCode, CommonCopy> = {
  en: {
    ...
    header: {
      ...
      download: 'Download',
      downloadAria: 'Download StoryForge desktop',
      downloadTitle: 'Download the desktop app',
      starAria: 'Star StoryForge on GitHub',
  ...
  zh: {
    ...
    header: {
      ...
      download: '下载',
      downloadAria: '下载 StoryForge 桌面端',
      downloadTitle: '下载桌面应用',
      starAria: '在 GitHub 为 StoryForge 点 Star',
  ...
  'zh-tw': {
    ...
    header: {
      ...
      download: '下載',
      downloadAria: '下載 StoryForge 桌面端',
      downloadTitle: '下載桌面應用',
      starAria: '在 GitHub 為 StoryForge 按 Star',
  ...
  ja: {
    ...
    header: {
      ...
      download: 'ダウンロード',
      downloadAria: 'StoryForge デスクトップをダウンロード',
      downloadTitle: 'デスクトップアプリをダウンロード',
      starAria: 'GitHub で StoryForge にスター',
  ...
  ko: {
    ...
    header: {
      ...
      download: '다운로드',
      downloadAria: 'StoryForge 데스크톱 다운로드',
      downloadTitle: '데스크톱 앱 다운로드',
      starAria: 'GitHub에서 StoryForge에 스타 주기',
  ...
  de: {
    ...
    header: {
      ...
      download: 'Download',
      downloadAria: 'StoryForge Desktop herunterladen',
      downloadTitle: 'Desktop-App herunterladen',
      starAria: 'StoryForge auf GitHub mit Stern markieren',
  ...
  fr: {
    ...
    header: {
      ...
      download: 'Télécharger',
      downloadAria: 'Télécharger StoryForge Desktop',
      downloadTitle: "Télécharger l'application desktop",
      starAria: 'Ajouter une étoile à StoryForge sur GitHub',
  ...
  ru: {
    ...
    header: {
      ...
      download: 'Скачать',
      downloadAria: 'Скачать StoryForge Desktop',
      downloadTitle: 'Скачать desktop-приложение',
      starAria: 'Поставить звезду StoryForge на GitHub',
  ...
  es: {
    ...
    header: {
      ...
      download: 'Descargar',
      downloadAria: 'Descargar StoryForge Desktop',
      downloadTitle: 'Descargar la app de escritorio',
      starAria: 'Dar Star a StoryForge en GitHub',
  ...
  'pt-br': {
    ...
    header: {
      ...
      download: 'Baixar',
      downloadAria: 'Baixar StoryForge Desktop',
      downloadTitle: 'Baixar o app desktop',
      starAria: 'Dar Star no StoryForge no GitHub',
  ...
  it: {
    ...
    header: {
      ...
      download: 'Scarica',
      downloadAria: 'Scarica StoryForge Desktop',
      downloadTitle: "Scarica l'app desktop",
      starAria: 'Metti una Star a StoryForge su GitHub',
  ...
  vi: {
    ...
    header: {
      ...
      download: 'Tải xuống',
      downloadAria: 'Tải StoryForge Desktop',
      downloadTitle: 'Tải ứng dụng desktop',
      starAria: 'Star StoryForge trên GitHub',
  ...
  pl: {
    ...
    header: {
      ...
      download: 'Pobierz',
      downloadAria: 'Pobierz StoryForge Desktop',
      downloadTitle: 'Pobierz aplikację desktop',
      starAria: 'Daj gwiazdkę StoryForge na GitHubie',
  ...
  id: {
    ...
    header: {
      ...
      download: 'Unduh',
      downloadAria: 'Unduh StoryForge Desktop',
      downloadTitle: 'Unduh aplikasi desktop',
      starAria: 'Beri Star StoryForge di GitHub',
  ...
  nl: {
    ...
    header: {
      ...
      download: 'Download',
      downloadAria: 'StoryForge Desktop downloaden',
      downloadTitle: 'Desktop-app downloaden',
      starAria: 'Geef StoryForge een Star op GitHub',
  ...
  ar: {
    ...
    header: {
      ...
      download: 'تنزيل',
      downloadAria: 'تنزيل StoryForge Desktop',
      downloadTitle: 'تنزيل تطبيق سطح المكتب',
      starAria: 'ضع نجمة لـ StoryForge على GitHub',
  ...
  tr: {
    ...
    header: {
      ...
      download: 'İndir',
      downloadAria: 'StoryForge Desktop indir',
      downloadTitle: 'Desktop uygulamasını indir',
      starAria: "GitHub'da StoryForge'a Star ver",
  ...
  uk: {
    ...
    header: {
      ...
      download: 'Завантажити',
      downloadAria: 'Завантажити StoryForge Desktop',
      downloadTitle: 'Завантажити desktop-застосунок',
      starAria: 'Поставити зірку StoryForge на GitHub',
...
const HOME_SEO_COPY: Record<LandingLocaleCode, HomeSeoCopy> = {
  en: {
    title: 'StoryForge — Best Open Source Claude Design Alternative',
    description:
  ...
  zh: {
    title: 'StoryForge —— 最佳 Claude Design 开源替代',
    description:
      'StoryForge 是开源的 vibe design workspace，也是 Claude Design 的开源替代——用你自己的 coding agent 做原型、落地页、仪表盘、Slides 和 HTML 视频。',
  },
  'zh-tw': {
    title: 'StoryForge —— 最佳 Claude Design 開源替代',
    description:
      'StoryForge 是最佳的開源、本地優先 Claude Design 替代方案。用 Claude Code、Codex、Cursor、Gemini、OpenCode 或 Qwen 生成簡報、落地頁、儀表板與品牌系統，背後由 {skills} 個可組合 Skill 與 {systems} 套 DESIGN.md 系統驅動。',
  },
  ja: {
    title: 'StoryForge — 最高のオープンソース Claude Design 代替',
    description:
      'オープンソースの vibe design workspace であり Claude Design の代替。自分の coding agent でプロトタイプ、ランディングページ、ダッシュボード、スライド、HTML 動画を作成。',
  },
  ko: {
    title: 'StoryForge — 최고의 오픈소스 Claude Design 대안',
    description:
      '오픈소스 vibe design workspace이자 Claude Design 대안. 내 coding agent로 프로토타입, 랜딩 페이지, 대시보드, 슬라이드, HTML 비디오를 만드세요.',
  },
  de: {
    title: 'StoryForge — beste Open-Source-Alternative zu Claude Design',
    description:
  ...
  fr: {
    title: "StoryForge — la meilleure alternative open source à Claude Design",
    description:
  ...
  ru: {
    title: 'StoryForge — лучшая open-source альтернатива Claude Design',
    description:
  ...
  es: {
    title: 'StoryForge — la mejor alternativa open source a Claude Design',
    description:
  ...
  'pt-br': {
    title: 'StoryForge — a melhor alternativa open source ao Claude Design',
    description:
  ...
  it: {
    title: "StoryForge — la migliore alternativa open source a Claude Design",
    description:
  ...
  vi: {
    title: 'StoryForge — lựa chọn mã nguồn mở tốt nhất thay Claude Design',
    description:
      'StoryForge là lựa chọn mã nguồn mở, local-first tốt nhất thay Claude Design. Tạo deck, landing page, dashboard và hệ thống thương hiệu bằng Claude Code, Codex, Cursor, Gemini, OpenCode hoặc Qwen, với {skills} skill có thể ghép và {systems} hệ DESIGN.md di động.',
  },
  pl: {
    title: 'StoryForge — najlepsza open-source alternatywa dla Claude Design',
    description:
      'StoryForge to najlepsza, open-source i local-first alternatywa dla Claude Design. Twórz decki, landing page, dashboardy i systemy marki z Claude Code, Codex, Cursor, Gemini, OpenCode lub Qwen, używając {skills} kompozycyjnych skills i {systems} przenośnych systemów DESIGN.md.',
  },
  id: {
    title: 'StoryForge — alternatif open source terbaik untuk Claude Design',
    description:
      'StoryForge adalah alternatif terbaik, open source, dan local-first untuk Claude Design. Buat deck, landing page, dashboard, dan sistem merek dengan Claude Code, Codex, Cursor, Gemini, OpenCode, atau Qwen, didukung {skills} skill komposable dan {systems} sistem DESIGN.md portabel.',
  },
  nl: {
    title: 'StoryForge — het beste open-source alternatief voor Claude Design',
    description:
      'StoryForge is het beste open-source en local-first alternatief voor Claude Design. Maak decks, landingspagina’s, dashboards en merksystemen met Claude Code, Codex, Cursor, Gemini, OpenCode of Qwen, aangedreven door {skills} combineerbare skills en {systems} draagbare DESIGN.md-systemen.',
  },
  ar: {
    title: 'StoryForge — أفضل بديل مفتوح المصدر لـ Claude Design',
    description:
      'StoryForge هو أفضل بديل مفتوح المصدر والمحلي أولاً لـ Claude Design. أنشئ عروضاً وصفحات هبوط ولوحات بيانات وأنظمة علامة عبر Claude Code أو Codex أو Cursor أو Gemini أو OpenCode أو Qwen، مع {skills} مهارة قابلة للتركيب و {systems} نظام DESIGN.md قابل للنقل.',
  },
  tr: {
    title: "StoryForge — Claude Design'ın en iyi açık kaynak alternatifi",
    description:
  ...
  uk: {
    title: 'StoryForge — найкраща open-source альтернатива Claude Design',
    description:
      'StoryForge — найкраща open-source і local-first альтернатива Claude Design. Створюйте презентації, лендинги, дашборди та бренд-системи через Claude Code, Codex, Cursor, Gemini, OpenCode або Qwen на базі {skills} skills і {systems} DESIGN.md-систем.',
  },
};
...
const HOME_FAQ_COPY: Record<LandingLocaleCode, HomeFaqTemplate[]> = {
  en: [
    {
      q: 'What is StoryForge?',
      a: 'StoryForge is the official open-source AI design workspace from the nexu-io/storyforge project. It turns a local coding agent — Claude Code, Codex, Cursor, Gemini CLI, OpenCode, or Qwen — into a design engine driven by composable skills and portable DESIGN.md systems.',
    },
    {
      q: 'Is StoryForge official?',
      a: 'Yes. The canonical project lives at {origin} and the source is on GitHub at {repo}. "StoryForge", "OpenDesign", "storyforge", and "StoryForge AI" all refer to this same project.',
      official: true,
    },
    {
      q: 'How is StoryForge different from Claude Design?',
      a: 'Claude Design is a hosted product tied to a single vendor. StoryForge is local-first, open source under Apache-2.0, and BYOK: you bring your own agent, credentials, and DESIGN.md system.',
    },
    {
      q: 'Is StoryForge an open-source Claude Design alternative?',
      a: 'Yes — StoryForge is the open-source, local-first Claude Design alternative. Where Claude Design is closed, hosted, and locked to Anthropic models, StoryForge is Apache-2.0, runs on your own machine, and is BYOK, so you drive it with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen and keep every artifact as files you own.',
      href: '/alternatives/claude-design/',
    },
    {
      q: 'What is a vibe design workspace?',
      a: 'A vibe design workspace is where you design by describing intent to an AI agent — from prompt to prototype, web page, slides, or HTML video — instead of hand-placing every element. StoryForge is an open-source, agent-native vibe design workspace: it wires the coding agent you already run into a full design workflow, so one tool takes you from a rough idea to production-ready output you own.',
      href: '/blog/what-is-vibe-design/',
    },
    {
      q: 'Does StoryForge run locally?',
    ...
    {
      q: 'Which coding agents does StoryForge support?',
      a: 'StoryForge ships 17 first-party BYOK adapters out of the box: Claude Code, Codex, Cursor, Gemini CLI, GitHub Copilot CLI, Grok, Hermes, Kimi, Devin for Terminal, OpenCode, Qwen, DeepSeek, Pi, Mistral Vibe, Kiro, Kilo, and Qoder. Any adapter that speaks the same skill protocol works — switching agents is a config change, not a redesign.',
    },
    {
    ...
    // evaluator concerns), then workflow / roadmap. ----
    {
      ...
      a: 'Only your prompt and skill context goes to whichever provider you bring keys for (BYOK). StoryForge has no server of its own — the daemon talks to your provider directly. Generated artifacts land as files in your project directory, not in any vendor cloud.',
    },
    {
      q: 'Can I run StoryForge without installing the CLI or desktop app?',
      a: 'Not today. StoryForge is local-first by design — the minimum is a local daemon plus an agent (Claude Code, Codex, Cursor, Gemini CLI, or one of the 17 supported adapters). A hosted sandbox is on the roadmap but not the priority: artifacts in your repo beat documents in someone else\'s database.',
    },
    {
      q: 'How much does StoryForge cost?',
      a: 'The product is free and Apache-2.0 — there is no StoryForge subscription. You pay the API costs of whichever provider you use (Anthropic, OpenAI, Google, Mistral, xAI, Moonshot, etc.), billed directly to your account. BYOK keeps both the credentials and the spend on your side of the line.',
    },
    {
      q: 'Can I self-host StoryForge on Vercel, Cloudflare, or my own server?',
    ...
    {
      q: 'How do I move my brand into StoryForge?',
    ...
    {
      q: 'What\'s on the StoryForge roadmap?',
  ...
  zh: [
    {
      q: 'StoryForge 是开源的 Claude Design 替代品吗？',
      a: '是的——StoryForge 是开源、本地优先的 Claude Design 替代方案。Claude Design 闭源、托管、锁定 Anthropic 模型；StoryForge 是 Apache-2.0，跑在你自己的机器上，且 BYOK，你可以用 Claude Code、Codex、Cursor、Gemini、OpenCode 或 Qwen 驱动它，产出的每个文件都归你所有。',
      href: '/alternatives/claude-design/',
    },
    {
      q: '什么是 vibe design workspace？',
      a: 'vibe design workspace 是通过向 AI agent 描述意图来做设计——从 prompt 到原型、网页、slides、HTML 视频——而不是手动摆放每个元素。StoryForge 是一个开源、agent-native 的 vibe design workspace：把你已经在用的 coding agent 接进完整设计工作流，一个工具就把你从粗略想法带到可交付、归你所有的成品。',
      href: '/blog/what-is-vibe-design/',
    },
    {
      q: 'StoryForge 是什么？',
      a: 'StoryForge 是 nexu-io/storyforge 项目的官方开源 AI 设计工作台。它把本地编码 Agent（Claude Code、Codex、Cursor、Gemini CLI、OpenCode 或 Qwen）变成设计引擎，并由可组合 SKILL.md 工作流驱动。',
    },
    {
      q: 'StoryForge 是官方项目吗？',
      a: '是。官方站点是 {origin}，源代码在 GitHub：{repo}。"StoryForge"、"OpenDesign"、"storyforge" 和 "StoryForge AI" 都指向同一个项目。',
      official: true,
    },
    {
      q: '它和 Claude Design 有什么不同？',
      a: 'Claude Design 是绑定单一厂商的云端产品。StoryForge 本地优先、Apache-2.0 开源，并且 BYOK：你使用自己的 Agent、密钥和 Skill 规则。',
    },
    {
      q: 'StoryForge 可以本地运行吗？',
    ...
    },
    {
      ...
      a: '只有你的 prompt 和 Skill 上下文会发给你自带密钥（BYOK）的那家模型供应商。StoryForge 没有自己的服务器——daemon 直接与你的供应商通信，生成的 artifact 以文件形式落在你的项目目录里，不会进入任何厂商云端。',
    },
    {
      q: '不安装 CLI 或桌面端能用 StoryForge 吗？',
      a: '目前不行。StoryForge 的设计就是本地优先——最少需要一个本地 daemon 加一个 Agent（Claude Code、Codex、Cursor、Gemini CLI 或 17 个受支持适配器之一）。托管沙盒在路线图上但不是优先级：落在你仓库里的 artifact，胜过存在别人数据库里的文档。',
    },
    {
      q: 'StoryForge 要多少钱？',
      a: '产品本身免费且为 Apache-2.0 开源——不存在 StoryForge 订阅。你只需支付所用供应商（Anthropic、OpenAI、Google、Mistral、xAI、Moonshot 等）的 API 费用，直接计入你自己的账户。BYOK 让密钥和开销都留在你这一侧。',
    },
    {
      q: '可以把 StoryForge 自托管到 Vercel、Cloudflare 或自己的服务器吗？',
  ...
  'zh-tw': [
    {
      q: 'StoryForge 是什麼？',
      a: 'StoryForge 是 nexu-io/storyforge 專案的官方開源 AI 設計工作台。它把本地 coding agent（Claude Code、Codex、Cursor、Gemini CLI、OpenCode 或 Qwen）變成設計引擎，並由可組合 Skill 與可攜式 DESIGN.md 系統驅動。',
    },
    {
      q: 'StoryForge 是官方專案嗎？',
      a: '是。官方站點是 {origin}，原始碼在 GitHub：{repo}。"StoryForge"、"OpenDesign"、"storyforge" 與 "StoryForge AI" 都指同一個專案。',
      official: true,
    },
    {
      q: '它和 Claude Design 有什麼不同？',
      a: 'Claude Design 是綁定單一供應商的雲端產品。StoryForge 本地優先、Apache-2.0 開源，並且 BYOK：你使用自己的 agent、密鑰與 DESIGN.md 設計系統。',
    },
    {
      q: 'StoryForge 可以本地執行嗎？',
    ...
    },
    {
      ...
      a: '只有你的 prompt 與 Skill 上下文會送到你自帶密鑰（BYOK）的那家模型供應商。StoryForge 沒有自己的伺服器——daemon 直接與你的供應商通訊，生成的 artifact 以檔案形式落在你的專案目錄，不會進入任何廠商雲端。',
    },
    {
      q: '不安裝 CLI 或桌面端能用 StoryForge 嗎？',
      a: '目前不行。StoryForge 的設計就是本地優先——最少需要一個本地 daemon 加一個 agent（Claude Code、Codex、Cursor、Gemini CLI 或 17 個受支援 adapter 之一）。託管沙盒在路線圖上但不是優先事項：落在你 repo 裡的 artifact，勝過存在別人資料庫裡的文件。',
    },
    {
      q: 'StoryForge 要多少錢？',
      a: '產品本身免費且採 Apache-2.0——不存在 StoryForge 訂閱。你只需支付所用供應商（Anthropic、OpenAI、Google、Mistral、xAI、Moonshot 等）的 API 費用，直接計入你自己的帳戶。BYOK 讓密鑰與開銷都留在你這一側。',
    },
    {
      q: '可以把 StoryForge 自架到 Vercel、Cloudflare 或自己的伺服器嗎？',
  ...
  ja: [
    {
      q: 'StoryForge はオープンソースの Claude Design 代替ですか？',
      a: 'はい——StoryForge はオープンソースかつローカル優先の Claude Design 代替です。Claude Design はクローズドでホスト型、Anthropic モデルに固定されていますが、StoryForge は Apache-2.0 で自分のマシン上で動き、BYOK。Claude Code、Codex、Cursor、Gemini、OpenCode、Qwen で駆動でき、生成物はすべて自分のファイルとして手元に残ります。',
      href: '/alternatives/claude-design/',
    },
    {
      q: 'vibe design workspace とは？',
      a: 'vibe design workspace とは、要素を一つずつ手で配置する代わりに、AI エージェントに意図を伝えて設計する場です——prompt からプロトタイプ、Web ページ、スライド、HTML 動画まで。StoryForge はオープンソースで agent-native な vibe design workspace で、すでに使っているコーディングエージェントを完全な設計ワークフローに組み込み、ひとつのツールでラフなアイデアから自分のものになる完成物まで導きます。',
      href: '/blog/what-is-vibe-design/',
    },
    {
      q: 'StoryForge とは何ですか？',
      a: 'StoryForge は nexu-io/storyforge プロジェクト公式のオープンソース AI デザインワークスペースです。Claude Code、Codex、Cursor、Gemini CLI、OpenCode、Qwen などのローカル coding agent を、スキルと DESIGN.md システムで動くデザインエンジンにします。',
    },
    {
      q: 'StoryForge は公式ですか？',
      a: 'はい。公式サイトは {origin}、ソースコードは GitHub の {repo} です。"StoryForge"、"OpenDesign"、"storyforge"、"StoryForge AI" は同じプロジェクトを指します。',
      official: true,
    },
    {
      q: 'Claude Design と何が違いますか？',
      a: 'Claude Design は単一ベンダーに紐づくホスト型製品です。StoryForge はローカル優先、Apache-2.0 のオープンソース、BYOK で、自分の agent、鍵、DESIGN.md を使います。',
    },
    {
      q: 'ローカルで動きますか？',
    ...
    },
    {
      ...
      a: '送られるのは、あなたが鍵を持ち込んだ（BYOK）プロバイダーへの prompt とスキルのコンテキストだけです。StoryForge 自身のサーバーはなく、daemon があなたのプロバイダーと直接通信します。生成物はベンダーのクラウドではなく、プロジェクトディレクトリにファイルとして保存されます。',
    },
    {
      q: 'CLI やデスクトップアプリなしで使えますか？',
      a: '現時点では使えません。StoryForge は設計からローカル優先で、最低限ローカル daemon と agent（Claude Code、Codex、Cursor、Gemini CLI、または対応する 17 の adapter のいずれか）が必要です。ホスト型サンドボックスはロードマップにありますが優先事項ではありません。自分の repo にある artifact は、他人のデータベースにあるドキュメントに勝ります。',
    },
    {
      q: 'StoryForge の料金は？',
      a: 'プロダクト自体は無料で Apache-2.0 です。StoryForge のサブスクリプションはありません。支払うのは利用するプロバイダー（Anthropic、OpenAI、Google、Mistral、xAI、Moonshot など）の API 料金だけで、あなたのアカウントに直接請求されます。BYOK により、鍵も支出もあなたの側に残ります。',
    },
    {
  ...
  ko: [
    {
      q: 'StoryForge은 오픈소스 Claude Design 대안인가요?',
      a: '네——StoryForge은 오픈소스, 로컬 우선 Claude Design 대안입니다. Claude Design은 폐쇄형·호스팅형이며 Anthropic 모델에 묶여 있지만, StoryForge은 Apache-2.0이고 내 컴퓨터에서 실행되며 BYOK입니다. Claude Code, Codex, Cursor, Gemini, OpenCode, Qwen으로 구동할 수 있고 생성된 모든 산출물은 내 파일로 남습니다.',
      href: '/alternatives/claude-design/',
    },
    {
      q: 'vibe design workspace란 무엇인가요?',
      a: 'vibe design workspace는 모든 요소를 손으로 배치하는 대신 AI 에이전트에 의도를 설명해 디자인하는 공간입니다 — prompt에서 프로토타입, 웹 페이지, 슬라이드, HTML 비디오까지. StoryForge은 오픈소스이자 agent-native한 vibe design workspace로, 이미 쓰는 코딩 에이전트를 완전한 디자인 워크플로에 연결해 하나의 도구로 거친 아이디어에서 내 것이 되는 완성물까지 이끕니다.',
      href: '/blog/what-is-vibe-design/',
    },
    {
      q: 'StoryForge은 무엇인가요?',
      a: 'StoryForge은 nexu-io/storyforge 프로젝트의 공식 오픈소스 AI 디자인 워크스페이스입니다. Claude Code, Codex, Cursor, Gemini CLI, OpenCode, Qwen 같은 로컬 coding agent를 조합형 skill과 DESIGN.md 시스템으로 구동되는 디자인 엔진으로 바꿉니다.',
    },
    {
      q: 'StoryForge은 공식 프로젝트인가요?',
      a: '네. 공식 사이트는 {origin}이고 소스는 GitHub의 {repo}에 있습니다. "StoryForge", "OpenDesign", "storyforge", "StoryForge AI"는 같은 프로젝트를 가리킵니다.',
      official: true,
    },
    {
      q: 'Claude Design과 무엇이 다른가요?',
      a: 'Claude Design은 단일 벤더에 묶인 호스팅 제품입니다. StoryForge은 로컬 우선, Apache-2.0 오픈소스, BYOK이며 사용자의 agent, 키, DESIGN.md 시스템을 그대로 씁니다.',
    },
    {
      q: '로컬에서 실행되나요?',
    ...
    },
    {
      ...
      a: '키를 직접 가져온(BYOK) 프로바이더에게 prompt와 skill 컨텍스트만 전송됩니다. StoryForge은 자체 서버가 없으며 daemon이 프로바이더와 직접 통신합니다. 생성된 artifact는 벤더 클라우드가 아니라 프로젝트 디렉터리에 파일로 저장됩니다.',
    },
    {
      q: 'CLI나 데스크톱 앱 없이 쓸 수 있나요?',
      a: '아직은 안 됩니다. StoryForge은 설계부터 로컬 우선이라 최소한 로컬 daemon과 agent(Claude Code, Codex, Cursor, Gemini CLI 또는 지원되는 17개 adapter 중 하나)가 필요합니다. 호스팅 샌드박스는 로드맵에 있지만 우선순위는 아닙니다. 내 repo에 남는 artifact가 남의 데이터베이스에 있는 문서보다 낫기 때문입니다.',
    },
    {
      q: 'StoryForge 비용은 얼마인가요?',
      a: '제품은 무료이고 Apache-2.0입니다. StoryForge 구독은 없습니다. 사용하는 프로바이더(Anthropic, OpenAI, Google, Mistral, xAI, Moonshot 등)의 API 비용만 본인 계정으로 직접 결제하면 됩니다. BYOK 덕분에 키와 지출 모두 사용자 쪽에 남습니다.',
    },
    {
  ...
  de: [
    {
      q: 'Ist StoryForge eine quelloffene Claude-Design-Alternative?',
      a: 'Ja — StoryForge ist die quelloffene, lokale Claude-Design-Alternative. Wo Claude Design geschlossen, gehostet und an Anthropic-Modelle gebunden ist, ist StoryForge Apache-2.0, läuft auf deinem eigenen Rechner und ist BYOK: Du steuerst es mit Claude Code, Codex, Cursor, Gemini, OpenCode oder Qwen und behältst jedes Ergebnis als eigene Dateien.',
      href: '/alternatives/claude-design/',
    },
    {
      q: 'Was ist ein Vibe Design Workspace?',
      a: 'Ein Vibe Design Workspace ist ein Ort, an dem du gestaltest, indem du einem KI-Agent deine Absicht beschreibst — vom Prompt zu Prototyp, Webseite, Slides oder HTML-Video — statt jedes Element von Hand zu platzieren. StoryForge ist ein quelloffener, agent-nativer Vibe Design Workspace: Er bindet den Coding-Agent, den du bereits nutzt, in einen vollständigen Design-Workflow ein, sodass ein Werkzeug dich von der groben Idee zum fertigen, dir gehörenden Ergebnis bringt.',
      href: '/blog/what-is-vibe-design/',
    },
    {
      q: 'Was ist StoryForge?',
      a: 'StoryForge ist der offizielle Open-Source-AI-Design-Workspace des Projekts nexu-io/storyforge. Es macht lokale Coding-Agents wie Claude Code, Codex, Cursor, Gemini CLI, OpenCode oder Qwen zu einer Design-Engine auf Basis von Skills und DESIGN.md-Systemen.',
    },
    {
      q: 'Ist StoryForge offiziell?',
      a: 'Ja. Die kanonische Website ist {origin}, der Quellcode liegt auf GitHub unter {repo}. "StoryForge", "OpenDesign", "storyforge" und "StoryForge AI" meinen dasselbe Projekt.',
      official: true,
    },
    {
      q: 'Worin unterscheidet es sich von Claude Design?',
      a: 'Claude Design ist ein gehostetes Produkt eines einzelnen Anbieters. StoryForge ist local-first, Apache-2.0 Open Source und BYOK: Sie bringen Agent, Schlüssel und DESIGN.md-System selbst mit.',
    },
    {
      q: 'Läuft StoryForge lokal?',
    ...
    },
    {
      ...
      a: 'Nur Ihr Prompt und der Skill-Kontext gehen an den Provider, für den Sie eigene Schlüssel mitbringen (BYOK). StoryForge hat keinen eigenen Server — der Daemon spricht direkt mit Ihrem Provider. Generierte Artifacts landen als Dateien in Ihrem Projektverzeichnis, nicht in einer Vendor-Cloud.',
    },
    {
      q: 'Kann ich StoryForge ohne CLI oder Desktop-App nutzen?',
      a: 'Heute nicht. StoryForge ist bewusst local-first — das Minimum ist ein lokaler Daemon plus ein Agent (Claude Code, Codex, Cursor, Gemini CLI oder einer der 17 unterstützten Adapter). Eine gehostete Sandbox steht auf der Roadmap, hat aber keine Priorität: Artifacts in Ihrem Repo schlagen Dokumente in fremden Datenbanken.',
    },
    {
      q: 'Was kostet StoryForge?',
    ...
    {
      q: 'Kann ich StoryForge auf Vercel, Cloudflare oder eigenen Servern hosten?',
    ...
    {
      q: 'Wie bringe ich meine Marke in StoryForge?',
  ...
  fr: [
    {
      q: 'StoryForge est-il une alternative open source à Claude Design ?',
      a: 'Oui — StoryForge est l’alternative open source et locale à Claude Design. Là où Claude Design est fermé, hébergé et verrouillé aux modèles Anthropic, StoryForge est en Apache-2.0, s’exécute sur votre propre machine et fonctionne en BYOK : pilotez-le avec Claude Code, Codex, Cursor, Gemini, OpenCode ou Qwen et gardez chaque livrable sous forme de fichiers qui vous appartiennent.',
      href: '/alternatives/claude-design/',
    },
    {
      q: 'Qu’est-ce qu’un vibe design workspace ?',
      a: 'Un vibe design workspace est un espace où l’on conçoit en décrivant son intention à un agent IA — du prompt au prototype, page web, slides ou vidéo HTML — plutôt qu’en plaçant chaque élément à la main. StoryForge est un vibe design workspace open source et agent-native : il intègre l’agent de code que vous utilisez déjà dans un flux de design complet, pour passer d’une idée brute à un résultat livrable et bien à vous.',
      href: '/blog/what-is-vibe-design/',
    },
    {
      q: "Qu'est-ce qu'StoryForge ?",
      a: "StoryForge est l'espace de travail officiel et open source du projet nexu-io/storyforge. Il transforme un agent local — Claude Code, Codex, Cursor, Gemini CLI, OpenCode ou Qwen — en moteur de design piloté par des skills composables et des systèmes DESIGN.md portables.",
    },
    {
      q: 'StoryForge est-il officiel ?',
      a: 'Oui. Le site canonique est {origin} et le code source est sur GitHub à {repo}. "StoryForge", "OpenDesign", "storyforge" et "StoryForge AI" désignent le même projet.',
      official: true,
    },
    {
      q: 'Quelle différence avec Claude Design ?',
      a: 'Claude Design est un produit hébergé lié à un fournisseur unique. StoryForge est local-first, open source Apache-2.0 et BYOK : vous apportez votre agent, vos clés et votre système DESIGN.md.',
    },
    {
      q: 'StoryForge fonctionne-t-il en local ?',
    ...
    },
    {
      ...
      a: 'Seuls votre prompt et le contexte des skills partent vers le fournisseur dont vous apportez les clés (BYOK). StoryForge n\'a aucun serveur propre — le daemon parle directement à votre fournisseur. Les artifacts générés sont des fichiers dans votre répertoire de projet, pas dans le cloud d\'un vendeur.',
    },
    {
      q: 'Puis-je utiliser StoryForge sans installer la CLI ou l\'app desktop ?',
      a: 'Pas aujourd\'hui. StoryForge est local-first par conception — le minimum est un daemon local plus un agent (Claude Code, Codex, Cursor, Gemini CLI ou l\'un des 17 adaptateurs supportés). Une sandbox hébergée est sur la roadmap mais n\'est pas la priorité : des artifacts dans votre repo valent mieux que des documents dans la base de données de quelqu\'un d\'autre.',
    },
    {
      q: 'Combien coûte StoryForge ?',
      a: 'Le produit est gratuit et sous Apache-2.0 — il n\'existe pas d\'abonnement StoryForge. Vous payez les coûts d\'API du fournisseur que vous utilisez (Anthropic, OpenAI, Google, Mistral, xAI, Moonshot, etc.), facturés directement sur votre compte. Le BYOK garde les clés et la dépense de votre côté.',
    },
    {
      q: 'Puis-je auto-héberger StoryForge sur Vercel, Cloudflare ou mon propre serveur ?',
    ...
    {
      q: 'Comment importer ma marque dans StoryForge ?',
    ...
    {
      q: 'Qu\'y a-t-il sur la roadmap d\'StoryForge ?',
  ...
  ru: [
    {
      q: 'StoryForge — это open-source альтернатива Claude Design?',
      a: 'Да — StoryForge это открытая, локальная альтернатива Claude Design. Claude Design закрыт, работает в облаке и привязан к моделям Anthropic, а StoryForge — Apache-2.0, запускается на вашей машине и работает по BYOK: управляйте им через Claude Code, Codex, Cursor, Gemini, OpenCode или Qwen и храните каждый результат как свои файлы.',
      href: '/alternatives/claude-design/',
    },
    {
      q: 'Что такое vibe design workspace?',
      a: 'Vibe design workspace — это среда, где вы проектируете, описывая замысел ИИ-агенту — от промпта до прототипа, веб-страницы, слайдов или HTML-видео — вместо расстановки каждого элемента вручную. StoryForge это открытый, agent-native vibe design workspace: он встраивает кодинг-агента, которым вы уже пользуетесь, в полный дизайн-процесс, и один инструмент ведёт вас от черновой идеи к готовому результату, который принадлежит вам.',
      href: '/blog/what-is-vibe-design/',
    },
    {
      q: 'Что такое StoryForge?',
      a: 'StoryForge — официальный open-source AI design workspace проекта nexu-io/storyforge. Он превращает локальный coding agent — Claude Code, Codex, Cursor, Gemini CLI, OpenCode или Qwen — в design-движок на базе composable skills и переносимых DESIGN.md-систем.',
    },
    {
      q: 'StoryForge официальный?',
      a: 'Да. Канонический сайт — {origin}, исходный код — на GitHub: {repo}. "StoryForge", "OpenDesign", "storyforge" и "StoryForge AI" обозначают один проект.',
      official: true,
    },
    {
      q: 'Чем он отличается от Claude Design?',
      a: 'Claude Design — hosted-продукт одного вендора. StoryForge — local-first, Apache-2.0 open source и BYOK: вы используете своего agent, свои ключи и свою DESIGN.md-систему.',
    },
    {
      q: 'StoryForge запускается локально?',
    ...
    },
    {
      ...
      a: 'Провайдеру, чьи ключи вы принесли (BYOK), уходят только ваш prompt и контекст skills. У StoryForge нет собственного сервера — daemon общается с вашим провайдером напрямую. Generated artifacts сохраняются файлами в папке проекта, а не в облаке вендора.',
    },
    {
      q: 'Можно использовать StoryForge без установки CLI или desktop-приложения?',
      a: 'Пока нет. StoryForge по замыслу local-first — минимум это локальный daemon плюс agent (Claude Code, Codex, Cursor, Gemini CLI или один из 17 поддерживаемых adapters). Hosted-песочница есть в роадмапе, но не в приоритете: artifacts в вашем репозитории лучше документов в чужой базе данных.',
    },
    {
      q: 'Сколько стоит StoryForge?',
      a: 'Продукт бесплатный и под Apache-2.0 — подписки StoryForge не существует. Вы платите только за API того провайдера, которым пользуетесь (Anthropic, OpenAI, Google, Mistral, xAI, Moonshot и др.), напрямую со своего аккаунта. BYOK оставляет и ключи, и расходы на вашей стороне.',
    },
    {
      q: 'Можно self-host StoryForge на Vercel, Cloudflare или своём сервере?',
    ...
    {
      q: 'Как перенести свой бренд в StoryForge?',
  ...
  es: [
    {
      q: '¿StoryForge es una alternativa open source a Claude Design?',
      a: 'Sí — StoryForge es la alternativa open source y local a Claude Design. Donde Claude Design es cerrado, alojado y atado a los modelos de Anthropic, StoryForge es Apache-2.0, se ejecuta en tu propia máquina y es BYOK: contrólalo con Claude Code, Codex, Cursor, Gemini, OpenCode o Qwen y conserva cada resultado como archivos que son tuyos.',
      href: '/alternatives/claude-design/',
    },
    {
      q: '¿Qué es un vibe design workspace?',
      a: 'Un vibe design workspace es un espacio donde diseñas describiendo tu intención a un agente de IA — del prompt al prototipo, página web, slides o vídeo HTML — en lugar de colocar cada elemento a mano. StoryForge es un vibe design workspace open source y agent-native: conecta el agente de código que ya usas a un flujo de diseño completo, de modo que una sola herramienta te lleva de una idea en bruto a un resultado listo y tuyo.',
      href: '/blog/what-is-vibe-design/',
    },
    {
      q: '¿Qué es StoryForge?',
      a: 'StoryForge es el workspace oficial y open source de IA de diseño del proyecto nexu-io/storyforge. Convierte un coding agent local — Claude Code, Codex, Cursor, Gemini CLI, OpenCode o Qwen — en un motor de diseño con skills componibles y sistemas DESIGN.md portables.',
    },
    {
      q: '¿StoryForge es oficial?',
      a: 'Sí. El sitio canónico es {origin} y el código fuente está en GitHub en {repo}. "StoryForge", "OpenDesign", "storyforge" y "StoryForge AI" apuntan al mismo proyecto.',
      official: true,
    },
    {
      q: '¿En qué se diferencia de Claude Design?',
      a: 'Claude Design es un producto alojado ligado a un solo proveedor. StoryForge es local-first, open source Apache-2.0 y BYOK: usas tu propio agent, claves y sistema DESIGN.md.',
    },
    {
      q: '¿StoryForge corre localmente?',
    ...
    },
    {
      ...
      a: 'Solo tu prompt y el contexto de skills van al proveedor cuyas claves aportas (BYOK). StoryForge no tiene servidor propio: el daemon habla directamente con tu proveedor. Los artifacts generados quedan como archivos en tu directorio de proyecto, no en la nube de ningún vendor.',
    },
    {
      q: '¿Puedo usar StoryForge sin instalar la CLI ni la app de escritorio?',
      a: 'Hoy no. StoryForge es local-first por diseño: el mínimo es un daemon local más un agent (Claude Code, Codex, Cursor, Gemini CLI o uno de los 17 adaptadores soportados). Un sandbox alojado está en el roadmap pero no es la prioridad: los artifacts en tu repo valen más que documentos en la base de datos de otro.',
    },
    {
      q: '¿Cuánto cuesta StoryForge?',
      a: 'El producto es gratuito y Apache-2.0: no existe una suscripción de StoryForge. Pagas los costes de API del proveedor que uses (Anthropic, OpenAI, Google, Mistral, xAI, Moonshot, etc.), facturados directamente a tu cuenta. BYOK mantiene las claves y el gasto de tu lado.',
    },
    {
      q: '¿Puedo autoalojar StoryForge en Vercel, Cloudflare o mi propio servidor?',
    ...
    {
      q: '¿Cómo llevo mi marca a StoryForge?',
    ...
    {
      q: '¿Qué hay en el roadmap de StoryForge?',
  ...
  'pt-br': [
    {
      q: 'O StoryForge é uma alternativa open source ao Claude Design?',
      a: 'Sim — o StoryForge é a alternativa open source e local ao Claude Design. Enquanto o Claude Design é fechado, hospedado e preso aos modelos da Anthropic, o StoryForge é Apache-2.0, roda na sua própria máquina e é BYOK: use Claude Code, Codex, Cursor, Gemini, OpenCode ou Qwen para conduzi-lo e mantenha cada entrega como arquivos que são seus.',
      href: '/alternatives/claude-design/',
    },
    {
      q: 'O que é um vibe design workspace?',
      a: 'Um vibe design workspace é onde você projeta descrevendo a intenção a um agente de IA — do prompt ao protótipo, página web, slides ou vídeo HTML — em vez de posicionar cada elemento à mão. O StoryForge é um vibe design workspace open source e agent-native: integra o coding agent que você já usa a um fluxo de design completo, então uma ferramenta leva você de uma ideia bruta a um resultado pronto e seu.',
      href: '/blog/what-is-vibe-design/',
    },
    {
      q: 'O que é StoryForge?',
      a: 'StoryForge é o workspace oficial, open source, de design com IA do projeto nexu-io/storyforge. Ele transforma um coding agent local — Claude Code, Codex, Cursor, Gemini CLI, OpenCode ou Qwen — em um motor de design movido por skills componíveis e sistemas DESIGN.md portáteis.',
    },
    {
      q: 'StoryForge é oficial?',
      a: 'Sim. O site canônico é {origin} e o código-fonte está no GitHub em {repo}. "StoryForge", "OpenDesign", "storyforge" e "StoryForge AI" apontam para o mesmo projeto.',
      official: true,
    },
    {
      q: 'Qual a diferença para o Claude Design?',
      a: 'Claude Design é um produto hospedado preso a um fornecedor. StoryForge é local-first, open source Apache-2.0 e BYOK: você traz seu agent, suas chaves e seu sistema DESIGN.md.',
    },
    {
      q: 'StoryForge roda localmente?',
    ...
    },
    {
      ...
      a: 'Só o seu prompt e o contexto de skills vão para o provedor cujas chaves você traz (BYOK). O StoryForge não tem servidor próprio — o daemon fala diretamente com o seu provedor. Os artifacts gerados ficam como arquivos no diretório do projeto, não na nuvem de nenhum vendor.',
    },
    {
      q: 'Posso usar o StoryForge sem instalar a CLI ou o app desktop?',
      a: 'Hoje não. O StoryForge é local-first por design — o mínimo é um daemon local mais um agent (Claude Code, Codex, Cursor, Gemini CLI ou um dos 17 adaptadores suportados). Um sandbox hospedado está no roadmap, mas não é prioridade: artifacts no seu repo valem mais que documentos no banco de dados de outra pessoa.',
    },
    {
      q: 'Quanto custa o StoryForge?',
      a: 'O produto é gratuito e Apache-2.0 — não existe assinatura do StoryForge. Você paga os custos de API do provedor que usar (Anthropic, OpenAI, Google, Mistral, xAI, Moonshot etc.), cobrados direto na sua conta. O BYOK mantém as chaves e o gasto do seu lado.',
    },
    {
      q: 'Posso auto-hospedar o StoryForge na Vercel, Cloudflare ou no meu servidor?',
    ...
    {
      q: 'Como levo minha marca para o StoryForge?',
    ...
    {
      q: 'O que tem no roadmap do StoryForge?',
  ...
  it: [
    {
      q: 'StoryForge è un’alternativa open source a Claude Design?',
      a: 'Sì — StoryForge è l’alternativa open source e locale a Claude Design. Dove Claude Design è chiuso, ospitato e legato ai modelli Anthropic, StoryForge è Apache-2.0, gira sulla tua macchina ed è BYOK: guidalo con Claude Code, Codex, Cursor, Gemini, OpenCode o Qwen e conserva ogni risultato come file tuoi.',
      href: '/alternatives/claude-design/',
    },
    {
      q: 'Che cos’è un vibe design workspace?',
      a: 'Un vibe design workspace è uno spazio in cui progetti descrivendo l’intento a un agente IA — dal prompt al prototipo, pagina web, slide o video HTML — invece di posizionare ogni elemento a mano. StoryForge è un vibe design workspace open source e agent-native: collega il coding agent che già usi a un flusso di design completo, così un solo strumento ti porta da un’idea grezza a un risultato pronto e tuo.',
      href: '/blog/what-is-vibe-design/',
    },
    {
      q: "Cos'è StoryForge?",
      a: 'StoryForge è il workspace ufficiale e open source di AI design del progetto nexu-io/storyforge. Trasforma un coding agent locale — Claude Code, Codex, Cursor, Gemini CLI, OpenCode o Qwen — in un motore di design guidato da skill componibili e sistemi DESIGN.md portabili.',
    },
    {
      q: 'StoryForge è ufficiale?',
      a: 'Sì. Il sito canonico è {origin} e il codice sorgente è su GitHub in {repo}. "StoryForge", "OpenDesign", "storyforge" e "StoryForge AI" indicano lo stesso progetto.',
      official: true,
    },
    {
      q: 'In cosa differisce da Claude Design?',
      a: 'Claude Design è un prodotto hosted legato a un solo vendor. StoryForge è local-first, open source Apache-2.0 e BYOK: usi il tuo agent, le tue chiavi e il tuo sistema DESIGN.md.',
    },
    {
      q: 'StoryForge gira in locale?',
    ...
    },
    {
      ...
      a: 'Al provider di cui porti le chiavi (BYOK) arrivano solo il tuo prompt e il contesto delle skill. StoryForge non ha server propri — il daemon parla direttamente con il tuo provider. Gli artifact generati restano come file nella directory del progetto, non nel cloud di un vendor.',
    },
    {
      q: 'Posso usare StoryForge senza installare la CLI o l\'app desktop?',
      a: 'Oggi no. StoryForge è local-first per progettazione — il minimo è un daemon locale più un agent (Claude Code, Codex, Cursor, Gemini CLI o uno dei 17 adapter supportati). Una sandbox hosted è nella roadmap ma non è la priorità: gli artifact nel tuo repo battono i documenti nel database di qualcun altro.',
    },
    {
      q: 'Quanto costa StoryForge?',
      a: 'Il prodotto è gratuito e Apache-2.0 — non esiste un abbonamento StoryForge. Paghi solo i costi API del provider che usi (Anthropic, OpenAI, Google, Mistral, xAI, Moonshot, ecc.), addebitati direttamente sul tuo account. Il BYOK tiene chiavi e spesa dalla tua parte.',
    },
    {
      q: 'Posso self-hostare StoryForge su Vercel, Cloudflare o un mio server?',
    ...
    {
      q: 'Come porto il mio brand in StoryForge?',
    ...
    {
      q: 'Cosa c\'è nella roadmap di StoryForge?',
  ...
  vi: [
    {
      q: 'StoryForge là gì?',
      a: 'StoryForge là workspace thiết kế AI mã nguồn mở chính thức của dự án nexu-io/storyforge. Nó biến coding agent chạy trên máy bạn — Claude Code, Codex, Cursor, Gemini CLI, OpenCode hoặc Qwen — thành engine thiết kế dựa trên skill ghép được và hệ DESIGN.md di động.',
    },
    {
      q: 'StoryForge có phải dự án chính thức không?',
      a: 'Có. Trang canonical là {origin}, mã nguồn ở GitHub: {repo}. "StoryForge", "OpenDesign", "storyforge" và "StoryForge AI" đều chỉ cùng một dự án.',
      official: true,
    },
    {
      q: 'Khác gì Claude Design?',
      a: 'Claude Design là sản phẩm hosted gắn với một nhà cung cấp. StoryForge local-first, open source Apache-2.0 và BYOK: bạn dùng agent, key và hệ DESIGN.md của chính mình.',
    },
    {
      q: 'StoryForge chạy local được không?',
    ...
    },
    {
      ...
      a: 'Chỉ prompt và ngữ cảnh skill của bạn được gửi tới nhà cung cấp mà bạn mang key tới (BYOK). StoryForge không có máy chủ riêng — daemon nói chuyện trực tiếp với nhà cung cấp của bạn. Artifact tạo ra nằm dưới dạng file trong thư mục dự án, không vào đám mây của vendor nào.',
    },
    {
      q: 'Có thể dùng StoryForge mà không cài CLI hay app desktop không?',
      a: 'Hiện chưa. StoryForge được thiết kế local-first — tối thiểu cần một daemon cục bộ cộng một agent (Claude Code, Codex, Cursor, Gemini CLI hoặc một trong 17 adapter được hỗ trợ). Sandbox hosted có trong roadmap nhưng không phải ưu tiên: artifact trong repo của bạn tốt hơn tài liệu trong cơ sở dữ liệu của người khác.',
    },
    {
      q: 'StoryForge giá bao nhiêu?',
      a: 'Sản phẩm miễn phí và theo Apache-2.0 — không có gói thuê bao StoryForge. Bạn chỉ trả chi phí API của nhà cung cấp mình dùng (Anthropic, OpenAI, Google, Mistral, xAI, Moonshot, v.v.), tính thẳng vào tài khoản của bạn. BYOK giữ cả key lẫn chi tiêu ở phía bạn.',
    },
    {
      q: 'Có thể self-host StoryForge trên Vercel, Cloudflare hay server riêng không?',
    ...
    {
      q: 'Làm sao đưa thương hiệu của tôi vào StoryForge?',
    ...
    {
      q: 'Roadmap của StoryForge có gì?',
  ...
  pl: [
    {
      q: 'Czym jest StoryForge?',
      a: 'StoryForge to oficjalny, open-source workspace AI design projektu nexu-io/storyforge. Zamienia lokalnego coding agenta — Claude Code, Codex, Cursor, Gemini CLI, OpenCode albo Qwen — w silnik designu oparty o kompozycyjne skills i przenośne systemy DESIGN.md.',
    },
    {
      q: 'Czy StoryForge jest oficjalne?',
      a: 'Tak. Kanoniczna strona to {origin}, a kod źródłowy jest na GitHubie: {repo}. "StoryForge", "OpenDesign", "storyforge" i "StoryForge AI" oznaczają ten sam projekt.',
      official: true,
    },
    {
      q: 'Czym różni się od Claude Design?',
      a: 'Claude Design to hostowany produkt jednego dostawcy. StoryForge jest local-first, open source Apache-2.0 i BYOK: używasz własnego agenta, kluczy i systemu DESIGN.md.',
    },
    {
      q: 'Czy StoryForge działa lokalnie?',
    ...
    },
    {
      ...
      a: 'Do dostawcy, którego klucze przynosisz (BYOK), trafia tylko Twój prompt i kontekst skills. StoryForge nie ma własnego serwera — daemon rozmawia z Twoim dostawcą bezpośrednio. Wygenerowane artifacts lądują jako pliki w katalogu projektu, a nie w chmurze żadnego vendora.',
    },
    {
      q: 'Czy mogę używać StoryForge bez instalowania CLI ani aplikacji desktop?',
      a: 'Dziś nie. StoryForge jest local-first z założenia — minimum to lokalny daemon plus agent (Claude Code, Codex, Cursor, Gemini CLI albo jeden z 17 wspieranych adapterów). Hostowany sandbox jest w roadmapie, ale nie jest priorytetem: artifacts w Twoim repo są lepsze niż dokumenty w cudzej bazie danych.',
    },
    {
      q: 'Ile kosztuje StoryForge?',
      a: 'Produkt jest darmowy i na licencji Apache-2.0 — nie istnieje subskrypcja StoryForge. Płacisz tylko koszty API dostawcy, którego używasz (Anthropic, OpenAI, Google, Mistral, xAI, Moonshot itd.), rozliczane bezpośrednio na Twoim koncie. BYOK trzyma i klucze, i wydatki po Twojej stronie.',
    },
    {
      q: 'Czy mogę self-hostować StoryForge na Vercel, Cloudflare albo własnym serwerze?',
    ...
    {
      q: 'Jak przenieść moją markę do StoryForge?',
    ...
    {
      q: 'Co jest w roadmapie StoryForge?',
  ...
  id: [
    {
      q: 'Apa itu StoryForge?',
      a: 'StoryForge adalah workspace AI design resmi dan open source dari proyek nexu-io/storyforge. Ia mengubah coding agent lokal — Claude Code, Codex, Cursor, Gemini CLI, OpenCode, atau Qwen — menjadi mesin desain berbasis skill komposable dan sistem DESIGN.md portabel.',
    },
    {
      q: 'Apakah StoryForge resmi?',
      a: 'Ya. Situs canonical ada di {origin} dan source code ada di GitHub: {repo}. "StoryForge", "OpenDesign", "storyforge", dan "StoryForge AI" merujuk ke proyek yang sama.',
      official: true,
    },
    {
      q: 'Apa bedanya dengan Claude Design?',
      a: 'Claude Design adalah produk hosted yang terikat pada satu vendor. StoryForge local-first, open source Apache-2.0, dan BYOK: Anda memakai agent, key, dan sistem DESIGN.md sendiri.',
    },
    {
      q: 'Apakah StoryForge berjalan lokal?',
    ...
    },
    {
      ...
      a: 'Hanya prompt dan konteks skill Anda yang pergi ke provider yang key-nya Anda bawa (BYOK). StoryForge tidak punya server sendiri — daemon bicara langsung dengan provider Anda. Artifact yang dihasilkan tersimpan sebagai file di direktori proyek, bukan di cloud vendor mana pun.',
    },
    {
      q: 'Bisakah memakai StoryForge tanpa menginstal CLI atau app desktop?',
      a: 'Belum bisa. StoryForge memang local-first — minimumnya adalah daemon lokal plus satu agent (Claude Code, Codex, Cursor, Gemini CLI, atau salah satu dari 17 adapter yang didukung). Sandbox hosted ada di roadmap tapi bukan prioritas: artifact di repo Anda lebih baik daripada dokumen di database orang lain.',
    },
    {
      q: 'Berapa biaya StoryForge?',
      a: 'Produknya gratis dan Apache-2.0 — tidak ada langganan StoryForge. Anda hanya membayar biaya API provider yang Anda pakai (Anthropic, OpenAI, Google, Mistral, xAI, Moonshot, dll.), ditagih langsung ke akun Anda. BYOK menjaga key dan pengeluaran tetap di sisi Anda.',
    },
    {
      q: 'Bisakah self-host StoryForge di Vercel, Cloudflare, atau server sendiri?',
    ...
    {
      q: 'Bagaimana memindahkan brand saya ke StoryForge?',
    ...
    {
      q: 'Apa saja di roadmap StoryForge?',
  ...
  nl: [
    {
      q: 'Wat is StoryForge?',
      a: 'StoryForge is de officiële open-source AI design workspace van het project nexu-io/storyforge. Het verandert een lokale coding agent — Claude Code, Codex, Cursor, Gemini CLI, OpenCode of Qwen — in een design-engine met combineerbare skills en draagbare DESIGN.md-systemen.',
    },
    {
      q: 'Is StoryForge officieel?',
      a: 'Ja. De canonieke site is {origin} en de broncode staat op GitHub: {repo}. "StoryForge", "OpenDesign", "storyforge" en "StoryForge AI" verwijzen naar hetzelfde project.',
      official: true,
    },
    {
      q: 'Wat is het verschil met Claude Design?',
      a: 'Claude Design is een hosted product van één leverancier. StoryForge is local-first, Apache-2.0 open source en BYOK: je gebruikt je eigen agent, sleutels en DESIGN.md-systeem.',
    },
    {
      q: 'Draait StoryForge lokaal?',
    ...
    },
    {
      ...
      a: 'Alleen je prompt en de skill-context gaan naar de provider waarvoor je zelf sleutels meebrengt (BYOK). StoryForge heeft geen eigen server — de daemon praat rechtstreeks met je provider. Gegenereerde artifacts komen als bestanden in je projectdirectory terecht, niet in de cloud van een vendor.',
    },
    {
      q: 'Kan ik StoryForge gebruiken zonder de CLI of desktop-app te installeren?',
      a: 'Vandaag niet. StoryForge is bewust local-first — het minimum is een lokale daemon plus een agent (Claude Code, Codex, Cursor, Gemini CLI of een van de 17 ondersteunde adapters). Een gehoste sandbox staat op de roadmap maar is geen prioriteit: artifacts in je repo verslaan documenten in andermans database.',
    },
    {
      q: 'Wat kost StoryForge?',
      a: 'Het product is gratis en Apache-2.0 — er bestaat geen StoryForge-abonnement. Je betaalt alleen de API-kosten van de provider die je gebruikt (Anthropic, OpenAI, Google, Mistral, xAI, Moonshot, enz.), rechtstreeks via je eigen account. BYOK houdt zowel de sleutels als de uitgaven aan jouw kant.',
    },
    {
      q: 'Kan ik StoryForge self-hosten op Vercel, Cloudflare of mijn eigen server?',
    ...
    {
      q: 'Hoe breng ik mijn merk naar StoryForge?',
    ...
    {
      q: 'Wat staat er op de roadmap van StoryForge?',
  ...
  ar: [
    {
      q: 'ما هو StoryForge؟',
      a: 'StoryForge هو مساحة عمل تصميم بالذكاء الاصطناعي رسمية ومفتوحة المصدر من مشروع nexu-io/storyforge. يحوّل coding agent محلياً مثل Claude Code أو Codex أو Cursor أو Gemini CLI أو OpenCode أو Qwen إلى محرك تصميم يعمل عبر skills قابلة للتركيب وأنظمة DESIGN.md قابلة للنقل.',
    },
    {
      q: 'هل StoryForge رسمي؟',
      a: 'نعم. الموقع canonical هو {origin} والمصدر على GitHub في {repo}. تشير "StoryForge" و"OpenDesign" و"storyforge" و"StoryForge AI" إلى المشروع نفسه.',
      official: true,
    },
    {
      q: 'ما الفرق عن Claude Design؟',
      a: 'Claude Design منتج مستضاف مرتبط بمورّد واحد. StoryForge محلي أولاً، مفتوح المصدر وفق Apache-2.0، وBYOK: تستخدم agent ومفاتيحك ونظام DESIGN.md الخاص بك.',
    },
    {
      q: 'هل يعمل StoryForge محلياً؟',
    ...
    },
    {
      ...
      a: 'لا يذهب إلى المزوّد الذي تجلب مفاتيحه (BYOK) سوى الـ prompt وسياق الـ skills. لا يملك StoryForge خادماً خاصاً به — يتواصل الـ daemon مع مزوّدك مباشرة. وتُحفظ الـ artifacts الناتجة كملفات في مجلد مشروعك، لا في سحابة أي مورّد.',
    },
    {
      q: 'هل يمكن استخدام StoryForge دون تثبيت CLI أو تطبيق سطح المكتب؟',
      a: 'ليس حالياً. صُمم StoryForge ليكون محلياً أولاً — الحد الأدنى هو daemon محلي مع agent واحد (Claude Code أو Codex أو Cursor أو Gemini CLI أو أحد الـ 17 adapter المدعومة). البيئة المستضافة موجودة في خارطة الطريق لكنها ليست أولوية: الـ artifacts في مستودعك أفضل من مستندات في قاعدة بيانات شخص آخر.',
    },
    {
      q: 'كم يكلّف StoryForge؟',
      a: 'المنتج مجاني وبرخصة Apache-2.0 — لا يوجد اشتراك في StoryForge. تدفع فقط تكاليف API للمزوّد الذي تستخدمه (Anthropic أو OpenAI أو Google أو Mistral أو xAI أو Moonshot وغيرها)، وتُحاسب مباشرة على حسابك. يبقي BYOK المفاتيح والإنفاق في جانبك.',
    },
    {
      q: 'هل يمكن استضافة StoryForge ذاتياً على Vercel أو Cloudflare أو خادمي الخاص؟',
    ...
    {
      q: 'كيف أنقل علامتي التجارية إلى StoryForge؟',
    ...
    {
      q: 'ماذا في خارطة طريق StoryForge؟',
  ...
  tr: [
    {
      q: 'StoryForge açık kaynaklı bir Claude Design alternatifi mi?',
      a: 'Evet — StoryForge açık kaynaklı, yerel çalışan Claude Design alternatifidir. Claude Design kapalı, barındırılan ve Anthropic modellerine kilitliyken; StoryForge Apache-2.0’dır, kendi makinende çalışır ve BYOK’tur: Claude Code, Codex, Cursor, Gemini, OpenCode veya Qwen ile çalıştır, her çıktıyı sana ait dosyalar olarak sakla.',
      href: '/alternatives/claude-design/',
    },
    {
      q: 'Vibe design workspace nedir?',
      a: 'Vibe design workspace, her öğeyi elle yerleştirmek yerine bir yapay zeka ajanına niyetini anlatarak tasarım yaptığın yerdir — prompttan prototipe, web sayfasına, slaytlara veya HTML videoya. StoryForge açık kaynaklı, agent-native bir vibe design workspace’tir: hâlihazırda kullandığın kodlama ajanını eksiksiz bir tasarım akışına bağlar; tek bir araç seni kaba bir fikirden sana ait, teslime hazır bir sonuca götürür.',
      href: '/blog/what-is-vibe-design/',
    },
    {
      q: 'StoryForge nedir?',
      a: "StoryForge, nexu-io/storyforge projesinin resmi açık kaynak AI design workspace'idir. Claude Code, Codex, Cursor, Gemini CLI, OpenCode veya Qwen gibi yerel coding agent'ları, birleştirilebilir skill'ler ve taşınabilir DESIGN.md sistemleriyle çalışan bir tasarım motoruna dönüştürür.",
    },
    {
      q: 'StoryForge resmi mi?',
      a: 'Evet. Kanonik site {origin}, kaynak kod GitHub üzerinde {repo}. "StoryForge", "OpenDesign", "storyforge" ve "StoryForge AI" aynı projeyi anlatır.',
      official: true,
    },
    {
      q: "Claude Design'dan farkı ne?",
      a: 'Claude Design tek bir vendor’a bağlı hosted bir üründür. StoryForge local-first, Apache-2.0 açık kaynak ve BYOK’tur: kendi agent’ını, anahtarlarını ve DESIGN.md sistemini kullanırsın.',
    },
    {
      q: 'StoryForge yerelde çalışır mı?',
    ...
    },
    {
      ...
      a: 'Yalnızca prompt\'unuz ve skill bağlamı, anahtarlarını kendinizin getirdiği (BYOK) sağlayıcıya gider. StoryForge\'ın kendi sunucusu yoktur — daemon doğrudan sağlayıcınızla konuşur. Üretilen artifact\'ler herhangi bir vendor bulutuna değil, proje dizininize dosya olarak düşer.',
    },
    {
      q: 'CLI veya desktop app kurmadan StoryForge kullanılabilir mi?',
      a: 'Bugün için hayır. StoryForge tasarımı gereği local-first\'tür — minimum, yerel bir daemon artı bir agent\'tır (Claude Code, Codex, Cursor, Gemini CLI veya desteklenen 17 adapter\'dan biri). Hosted bir sandbox roadmap\'te var ama öncelik değil: repo\'nuzdaki artifact\'ler, başkasının veritabanındaki belgelerden iyidir.',
    },
    {
      q: 'StoryForge\'ın maliyeti nedir?',
      a: 'Ürün ücretsiz ve Apache-2.0 lisanslıdır — StoryForge aboneliği yoktur. Yalnızca kullandığınız sağlayıcının (Anthropic, OpenAI, Google, Mistral, xAI, Moonshot vb.) API maliyetini ödersiniz; doğrudan kendi hesabınıza faturalandırılır. BYOK hem anahtarları hem harcamayı sizin tarafınızda tutar.',
    },
    {
      q: 'StoryForge\'ı Vercel, Cloudflare veya kendi sunucumda self-host edebilir miyim?',
    ...
    {
      q: 'Markamı StoryForge\'a nasıl taşırım?',
    ...
    {
      q: 'StoryForge roadmap\'inde neler var?',
  ...
  uk: [
    {
      q: 'Що таке StoryForge?',
      a: 'StoryForge — офіційний open-source AI design workspace проєкту nexu-io/storyforge. Він перетворює локальний coding agent — Claude Code, Codex, Cursor, Gemini CLI, OpenCode або Qwen — на design-двигун із composable skills і переносними DESIGN.md-системами.',
    },
    {
      q: 'StoryForge офіційний?',
      a: 'Так. Канонічний сайт — {origin}, вихідний код на GitHub: {repo}. "StoryForge", "OpenDesign", "storyforge" і "StoryForge AI" означають один проєкт.',
      official: true,
    },
    {
      q: 'Чим він відрізняється від Claude Design?',
      a: 'Claude Design — hosted-продукт одного вендора. StoryForge — local-first, Apache-2.0 open source і BYOK: ви використовуєте свого agent, свої ключі та свою DESIGN.md-систему.',
    },
    {
      q: 'StoryForge запускається локально?',
    ...
    },
    {
      ...
      a: 'Провайдеру, чиї ключі ви принесли (BYOK), іде лише ваш prompt і контекст skills. В StoryForge немає власного сервера — daemon спілкується з вашим провайдером напряму. Generated artifacts зберігаються файлами в папці проєкту, а не в хмарі вендора.',
    },
    {
      q: 'Чи можна користуватися StoryForge без встановлення CLI чи desktop-застосунку?',
      a: 'Поки ні. StoryForge за задумом local-first — мінімум це локальний daemon плюс agent (Claude Code, Codex, Cursor, Gemini CLI або один із 17 підтримуваних adapters). Hosted-пісочниця є в роадмапі, але не в пріоритеті: artifacts у вашому репозиторії кращі за документи в чужій базі даних.',
    },
    {
      q: 'Скільки коштує StoryForge?',
      a: 'Продукт безплатний і під Apache-2.0 — підписки StoryForge не існує. Ви платите лише за API того провайдера, яким користуєтеся (Anthropic, OpenAI, Google, Mistral, xAI, Moonshot тощо), напряму зі свого акаунта. BYOK залишає і ключі, і витрати на вашому боці.',
    },
    {
      q: 'Чи можна self-host StoryForge на Vercel, Cloudflare або власному сервері?',
    ...
    {
      q: 'Як перенести свій бренд в StoryForge?',
...
const HOME_PAGE_COPY_EN: HomePageCopy = {
  rail: {
    right: 'StoryForge — Vol. 01 · Issue Nº 26 · Apache-2.0',
    left: 'Skills · Systems · Agents · BYOK · Local-first',
  },
  hero: {
    discordAria: 'Join the StoryForge Discord',
    ...
    lead: (skills, systems) =>
      `StoryForge is the official, local-first alternative to Claude Design. Your existing coding agent — Claude Code · Codex · Cursor · Gemini · OpenCode · Qwen — becomes the design engine, driven by ${skills} composable skills and ${systems} portable DESIGN.md systems.`,
  ...
  official: {
    aria: 'Official StoryForge sources',
    label: 'Official source',
    items: [
      { label: 'Official site', value: 'storyforge.ai' },
      { label: 'Source', value: 'nexu-io/storyforge' },
  ...
  about: {
    ...
    caption: 'Studies in form · perception · machine imagination. (StoryForge, MMXXVI)',
  },
  capabilities: {
  ...
  testimonial: {
    ...
    label: 'Collaborators',
    quote:
      '“StoryForge helped us turn vague AI ideas into a visual system that felt sharp, believable, and genuinely new.”',
  ...
  footer: {
    ...
    downloadAria: 'Download the StoryForge desktop app',
    download: 'Download desktop',
    columns: {
      studio: 'Studio',
      library: 'Library',
      connect: 'Connect',
      openDesign: 'StoryForge',
    },
    ...
    bottomLeft: 'StoryForge · Apache-2.0 · 2026 / Volume 01 / Issue Nº 26',
...
const HOME_PAGE_COPY: Partial<Record<LandingLocaleCode, HomePageCopy>> = {
  ...
  zh: {
    rail: {
      right: 'StoryForge — 第 01 卷 · 第 26 期 · Apache-2.0',
      left: 'Skills · UIUX Design · Agents · BYOK · 本地优先',
    },
    hero: {
      discordAria: '加入 StoryForge Discord',
      ...
      lead: (skills) =>
        `StoryForge 是官方、本地优先的 Claude Design 替代方案。你现有的编码 Agent —— Claude Code · Codex · Cursor · Gemini · OpenCode · Qwen —— 会变成设计引擎，并由 ${skills} 个可组合 SKILL.md 工作流驱动。`,
      star: 'Download',
      download: '下载桌面端',
      plate: '图版 Nº 08',
      composedIn: '由',
    ...
    official: {
      aria: 'StoryForge 官方来源',
      label: '官方来源',
      items: [
        { label: '官方网站', value: 'storyforge.ai' },
        { label: '源码', value: 'nexu-io/storyforge' },
    ...
    about: {
      ...
      caption: '形式 · 感知 · 机器想象力研究。（StoryForge，MMXXVI）',
    },
    capabilities: {
      rule: '能力 · Skill · 规范',
    ...
    testimonial: {
      ...
      shoulders: '站在前人的肩膀上',
      label: '协作者',
      quote: '来自全球，100+ 贡献者正在一起构建 StoryForge',
      authorName: 'Mina Kovac',
    ...
    footer: {
      ...
      downloadAria: '下载 StoryForge 桌面应用',
      download: '下载桌面端',
      columns: {
        studio: '工作室',
        library: 'Skill',
    ...
    libraryLinks: {
      ...
      bottomLeft: 'StoryForge · Apache-2.0 · 2026 / 第 01 卷 / 第 26 期',
...
HOME_PAGE_COPY['zh-tw'] = {
  ...
  hero: {
    ...
    titleSecondEmphasis: '你自己的 Agent 上',
    lead: (skills, systems) =>
      `StoryForge 是官方、本地優先的 Claude Design 替代方案。你現有的 coding agent —— Claude Code · Codex · Cursor · Gemini · OpenCode · Qwen —— 會變成設計引擎，並由 ${skills} 個可組合 Skill 與 ${systems} 套可攜式 DESIGN.md 系統驅動。`,
  ...
  official: {
    ...
    label: '官方來源',
    items: [
      { label: '官方網站', value: 'storyforge.ai' },
      { label: '原始碼', value: 'nexu-io/storyforge' },
  ...
  about: {
    ...
    caption: '形式 · 感知 · 機器想像力研究。（StoryForge，MMXXVI）',
  },
  capabilities: {
  ...
  testimonial: {
    ...
    shoulders: '站在前人的肩膀上',
    label: '協作者',
    quote: '“StoryForge 幫我們把模糊的 AI 想法變成了一個視覺系統：鋒利、可信，而且真的有新意。”',
  ...
  footer: {
    ...
    downloadAria: '下載 StoryForge 桌面應用',
    download: '下載桌面端',
    columns: {
      studio: '工作室',
      library: '資源庫',
...
const LANDING_UI_COPY: LandingUiCopy = {
  ...
  blog: {
    title: 'Blog',
    seoTitle: 'Blog — StoryForge',
    description:
      'Notes to help you understand, explore, and build with StoryForge — across product, guides, use cases, and community.',
  ...
  tutorials: {
    title: 'StoryForge Tutorials',
    seoTitle: 'StoryForge Tutorials — Free Video Guides & How-Tos',
    description:
      'Learn how to use StoryForge with step-by-step video tutorials — getting started, plugins, design systems, and real workflows. Every guide plays right on the page.',
    ...
    contributeTitle: 'Made an StoryForge tutorial?',
    contributeBody:
    ...
    detailTitle: (title) => `${title} — StoryForge Tutorials`,
  ...
  catalog: {
    ...
    skills: {
      title: (count) => `Skills — ${count} composable design capabilities | StoryForge`,
      description:
        'Browse the full StoryForge skills catalog: 100+ file-based SKILL.md bundles spanning decks, prototypes, dashboards, mobile flows, video, and live artifacts. Each skill is a folder you drop into the daemon.',
      label: 'Catalog · Nº 01',
      ...
      featured: 'Featured',
      allAria: 'All skills',
      detailTitle: (name) => `${name} — StoryForge skill`,
      detailFallbackDescription: (name) => `StoryForge skill bundle: ${name}.`,
      detailLabel: 'Skill',
      ...
      filterTitle: (heading, count) =>
        `${heading} skills — ${count} StoryForge ${heading.toLowerCase()} agents`,
      modeDescription: (heading, count) =>
        `Every StoryForge skill that produces ${heading.toLowerCase()} artifacts. ${count} ready-to-run, system-aware agents — installable through the daemon, brand-locked through any DESIGN.md system.`,
      scenarioDescription: (heading, count) =>
        `Every StoryForge skill in the ${heading.toLowerCase()} scenario. ${count} ready-to-run agents covering decks, prototypes, templates, and live artifacts — all brand-locked through any DESIGN.md.`,
    ...
    systems: {
      title: (count) => `Design Systems — ${count} portable visual systems | StoryForge`,
      description:
        'Browse the full StoryForge design systems catalog: 100+ DESIGN.md token bundles spanning editorial, productivity, brand, futuristic, and minimalist systems. Pick one in the daemon top-bar and every skill renders in that visual language.',
      label: 'Catalog · Nº 02',
      ...
      category: 'Category',
      allAria: 'All systems',
      detailTitle: (name) => `${name} — StoryForge design system`,
      detailFallbackDescription: (name, category) =>
        `StoryForge system bundle: ${name}, ${category}.`,
      ...
      categoryDescription: (heading, count) =>
        `Every StoryForge design system tagged ${heading.toLowerCase()}. ${count} portable DESIGN.md token bundles — ready to pair with any skill in the catalog for instant brand-grade output.`,
    ...
    templates: {
      title: (count) => `Templates — ${count} ready-to-fork artifact templates | StoryForge`,
      description:
      ...
      detailTitle: (name) => `${name} — StoryForge template`,
    ...
    craft: {
      title: (count) => `Craft — ${count} brand-agnostic rendering principles | StoryForge`,
      description:
        'Universal craft rules every StoryForge skill can opt into: accessibility, animation discipline, color, form validation, laws of UX, RTL/Bidi, state coverage, and typography hierarchy.',
      label: 'Catalog · Nº 03',
      ...
      detailTitle: (name) => `${name} — StoryForge craft principle`,
      detailFallbackDescription: (name) => `StoryForge craft rule: ${name}.`,
  ...
  plugins: {
    registryTitle: 'StoryForge Plugins — Official and community registries',
    registryDescription: (count) =>
      `Browse ${count} StoryForge plugins from official and community registries. Search installable agent-native design workflows with stable vendor/plugin IDs.`,
    directoryRailRight: 'StoryForge Registry · Official · Community',
    ...
    details: 'Details',
    detailTitle: (title) => `${title} — StoryForge Plugin`,
    detailDescription: (description, command) => `${description} Install with ${command}.`,
    detailRailRight: (id) => `StoryForge Plugin · ${id}`,
...
> = {
  zh: {
    ...
    blog: {
      title: '博客',
      seoTitle: '博客 — StoryForge',
      description:
        '理解、探索和构建 StoryForge 的笔记，覆盖产品、指南、使用场景与社区。',
    ...
    tutorials: {
      title: '教程',
      seoTitle: '教程 — StoryForge',
      description:
        '观看 StoryForge 的上手 walkthrough、插件教程、演示、评测与社区视频。所有视频都在页面内播放，并保留原始 YouTube 来源。',
      ...
      contributeTitle: '做过 StoryForge 的教程？',
      contributeBody:
        '把你的视频分享给社区——在简单的表单里贴个链接就行，维护者会把它加到这个页面。',
      contributeCta: '提交一个教程 ↗',
      contributeSuggest: '想直接提 PR？↗',
      thumbnailAlt: (title) => `${title} 的视频封面`,
      detailTitle: (title) => `${title} — StoryForge 教程`,
      localizedTitle: (_title, author) => `StoryForge 教程：${author}`,
      localizedSummary: (_title, author, category) =>
        `${author} 通过一段 ${category} 视频讲解 StoryForge 的本地优先设计工作流、Skill、设计系统与可复用模板。`,
      localizedBodyHtml: (_title, author, summary) =>
        `<p>${summary}</p><h2>本地化摘要</h2><p>这段视频来自 ${author}，围绕 StoryForge 的安装、能力演示、设计系统、Skill 和本地 Agent 工作流展开。页面保留原始视频来源，非英文页面使用站内 i18n 摘要，让正文不会回退成英文。</p>`,
    },
    catalog: {
      skills: {
        title: (count) => `Skill — ${count} 个可组合设计能力 | StoryForge`,
        description:
          '浏览完整的 StoryForge Skill 目录：100+ 个基于 SKILL.md 的文件夹，覆盖演示文稿、原型、仪表盘、移动流程、视频与实时 Artifact。每个 Skill 都是一个可放入 daemon 的文件夹。',
        label: '目录 · Nº 01',
        ...
        allAria: '全部 Skill',
        detailTitle: (name) => `${name} — StoryForge Skill`,
        detailFallbackDescription: (name) => `StoryForge Skill 包：${name}。`,
        detailLabel: 'Skill',
        ...
        related: '相关 Skill',
        filterTitle: (heading, count) =>
          `${heading} Skill — ${count} 个 StoryForge ${heading.toLowerCase()} Agent`,
        modeDescription: (heading, count) =>
          `所有生成 ${heading.toLowerCase()} Artifact 的 StoryForge Skill。${count} 个可直接运行、读取系统上下文的 Agent，可以通过 daemon 安装，并通过任意 DESIGN.md 系统锁定品牌。`,
        scenarioDescription: (heading, count) =>
          `${heading.toLowerCase()} 场景下的全部 StoryForge Skill。${count} 个可运行 Agent，覆盖演示文稿、原型、模板与实时 Artifact，并可通过任意 DESIGN.md 锁定品牌。`,
        modeHeading: (heading, count) =>
      ...
      systems: {
        title: (count) => `设计系统 — ${count} 套可移植视觉系统 | StoryForge`,
        description:
          '浏览完整的 StoryForge 设计系统目录：100+ 个 DESIGN.md token 包，覆盖 editorial、productivity、brand、futuristic 与 minimalist 等系统。你可以在 daemon 顶栏选择一个系统，让所有 Skill 以同一种视觉语言渲染。',
        label: '目录 · Nº 02',
        ...
        category: '分类',
        allAria: '全部设计系统',
        detailTitle: (name) => `${name} — StoryForge 设计系统`,
        detailFallbackDescription: (name, category) =>
          `StoryForge 系统包：${name}，${category}。`,
        detailLabel: '设计系统',
        ...
        categoryDescription: (heading, count) =>
          `所有标记为 ${heading.toLowerCase()} 的 StoryForge 设计系统。${count} 套可移植 DESIGN.md token 包，可与目录中任意 Skill 搭配，快速得到品牌级输出。`,
        categoryHeading: (heading, count) =>
      ...
      templates: {
        title: (count) => `模板 — ${count} 个可 fork 的 Artifact 模板 | StoryForge`,
        description:
        ...
        detailTitle: (name) => `${name} — StoryForge 模板`,
        detailLabel: '模板',
      ...
      craft: {
        title: (count) => `工艺规则 — ${count} 条品牌无关渲染原则 | StoryForge`,
        description:
          '每个 StoryForge Skill 都可以声明要加载的通用工艺规则：无障碍、动画纪律、颜色、表单验证、UX 法则、RTL/Bidi、状态覆盖和字体层级。',
        label: '目录 · Nº 03',
        heading: (count) => `工艺规则 — ${count} 条品牌无关渲染原则。`,
        lead:
          'Skill 会声明它需要哪些工艺规则。Agent 会把匹配的规则加载进系统提示，让无障碍、动效、颜色和字体等质量要求在不同视觉系统中保持不变。',
        allAria: '全部工艺规则',
        detailTitle: (name) => `${name} — StoryForge 工艺规则`,
        detailFallbackDescription: (name) => `StoryForge 工艺规则：${name}。`,
        detailLabel: '工艺规则',
    ...
    plugins: {
      registryTitle: 'StoryForge 插件 — 官方与社区注册表',
      registryDescription: (count) =>
        `浏览来自官方与社区注册表的 ${count} 个 StoryForge 插件。搜索可安装的 Agent 原生设计工作流，每个条目都有稳定的 vendor/plugin ID。`,
      directoryRailRight: 'StoryForge 注册表 · 官方 · 社区',
      directoryRailLeft: 'vendor/plugin-name · marketplace.json',
      topbarTitle: 'OD / 注册表',
      topbarSubtitle: '公开索引',
      ...
      details: '详情',
      detailTitle: (title) => `${title} — StoryForge 插件`,
      detailDescription: (description, command) => `${description} 使用 ${command} 安装。`,
      detailRailRight: (id) => `StoryForge 插件 · ${id}`,
      allPlugins: '全部插件',
      registry: '注册表',
      deprecated: '已弃用',
      yanked: '已下架',
  ...
  'zh-tw': {
    ...
    blog: {
      title: '部落格',
      seoTitle: '部落格 — StoryForge',
      description:
        '理解、探索與建構 StoryForge 的筆記，涵蓋產品、指南、使用場景與社群。',
    ...
    tutorials: {
      title: '教學',
      seoTitle: '教學 — StoryForge',
      description:
        '觀看 StoryForge 的上手 walkthrough、外掛教學、演示、評測與社群影片。所有影片都在頁面內播放，並保留原始 YouTube 來源。',
      ...
      contributeTitle: '做過 StoryForge 的教學？',
      contributeBody:
        '把你的影片分享給社群——在簡單的表單裡貼個連結就行，維護者會把它加到這個頁面。',
      contributeCta: '提交一個教學 ↗',
      contributeSuggest: '想直接提 PR？↗',
      thumbnailAlt: (title) => `${title} 的影片封面`,
      detailTitle: (title) => `${title} — StoryForge 教學`,
      localizedTitle: (_title, author) => `StoryForge 教學：${author}`,
      localizedSummary: (_title, author, category) =>
        `${author} 透過一支 ${category} 影片講解 StoryForge 的本地優先設計工作流、Skill、設計系統與可複用模板。`,
      localizedBodyHtml: (_title, author, summary) =>
        `<p>${summary}</p><h2>本地化摘要</h2><p>這支影片來自 ${author}，圍繞 StoryForge 的安裝、能力演示、設計系統、Skill 與本地 Agent 工作流展開。頁面保留原始影片來源，非英文頁面使用站內 i18n 摘要，避免正文回退成英文。</p>`,
    },
  },
};
...
const HOME_PAGE_COPY_OVERRIDES: Partial<Record<LandingLocaleCode, DeepPartial<HomePageCopy>>> = {
  ja: {
    hero: {
      ...
      lead: (skills, systems) =>
        `StoryForge は公式のローカル優先 Claude Design 代替です。Claude Code、Codex、Cursor、Gemini、OpenCode、Qwen など既存の coding agent が、${skills} 個の composable skill と ${systems} 個の portable DESIGN.md system で動くデザインエンジンになります。`,
      star: 'GitHub で Star',
    ...
    faqSection: { rule: 'FAQ', answers: '公式回答', label: 'StoryForge よくある質問', titlePrefix: '', titleMiddle: 'と', titleSuffix: 'Claude Design のオープンソース代替について' },
  ...
  ko: {
    hero: {
      ...
      lead: (skills, systems) =>
        `StoryForge은 공식 local-first Claude Design 대안입니다. 이미 쓰는 Claude Code, Codex, Cursor, Gemini, OpenCode, Qwen 같은 coding agent가 ${skills}개의 조합형 skill과 ${systems}개의 portable DESIGN.md system으로 구동되는 디자인 엔진이 됩니다.`,
      star: 'GitHub에서 Star',
      download: '데스크톱 다운로드',
    },
    ...
    faqSection: { rule: 'FAQ', answers: '공식 답변', label: 'StoryForge 자주 묻는 질문', titlePrefix: '', titleMiddle: '및', titleSuffix: 'Claude Design 오픈소스 대안 질문' },
  ...
  de: {
    hero: {
      ...
      lead: (skills, systems) =>
        `StoryForge ist die offizielle local-first Alternative zu Claude Design. Dein vorhandener Coding-Agent — Claude Code, Codex, Cursor, Gemini, OpenCode oder Qwen — wird zur Design-Engine, gesteuert von ${skills} kombinierbaren Skills und ${systems} portablen DESIGN.md-Systemen.`,
  ...
  fr: {
    hero: {
      ...
      lead: (skills, systems) =>
        `StoryForge est l'alternative officielle, local-first, à Claude Design. Votre agent de coding — Claude Code, Codex, Cursor, Gemini, OpenCode ou Qwen — devient un moteur de design piloté par ${skills} skills composables et ${systems} systèmes DESIGN.md portables.`,
    ...
    faqSection: { rule: 'FAQ', answers: 'Réponses officielles', label: 'FAQ StoryForge', titlePrefix: 'Questions sur', titleMiddle: 'et', titleSuffix: "l'alternative open source à Claude Design" },
  ...
  ru: {
    hero: {
      ...
      lead: (skills, systems) =>
        `StoryForge — официальная local-first альтернатива Claude Design. Ваш coding agent — Claude Code, Codex, Cursor, Gemini, OpenCode или Qwen — становится design engine на базе ${skills} composable skills и ${systems} portable DESIGN.md systems.`,
    ...
    faqSection: { rule: 'FAQ', answers: 'Официальные ответы', label: 'Вопросы об StoryForge', titlePrefix: 'Вопросы про', titleMiddle: 'и', titleSuffix: 'open-source альтернативу Claude Design' },
  ...
  es: {
    hero: {
      ...
      lead: (skills, systems) =>
        `StoryForge es la alternativa oficial, local-first, a Claude Design. Tu coding agent — Claude Code, Codex, Cursor, Gemini, OpenCode o Qwen — se convierte en motor de diseño con ${skills} skills componibles y ${systems} sistemas DESIGN.md portables.`,
    ...
    faqSection: { rule: 'FAQ', answers: 'Respuestas oficiales', label: 'FAQ de StoryForge', titlePrefix: 'Preguntas sobre', titleMiddle: 'y', titleSuffix: 'la alternativa open source a Claude Design' },
  ...
  'pt-br': {
    hero: {
      ...
      lead: (skills, systems) =>
        `StoryForge é a alternativa oficial, local-first, ao Claude Design. Seu coding agent — Claude Code, Codex, Cursor, Gemini, OpenCode ou Qwen — vira um motor de design com ${skills} skills componíveis e ${systems} sistemas DESIGN.md portáteis.`,
    ...
    faqSection: { rule: 'FAQ', answers: 'Respostas oficiais', label: 'FAQ StoryForge', titlePrefix: 'Perguntas sobre', titleMiddle: 'e', titleSuffix: 'a alternativa open source ao Claude Design' },
  ...
  it: {
    hero: {
      ...
      lead: (skills, systems) =>
        `StoryForge è l'alternativa ufficiale, local-first, a Claude Design. Il tuo coding agent — Claude Code, Codex, Cursor, Gemini, OpenCode o Qwen — diventa un motore di design con ${skills} skill componibili e ${systems} sistemi DESIGN.md portabili.`,
    ...
    faqSection: { rule: 'FAQ', answers: 'Risposte ufficiali', label: 'FAQ StoryForge', titlePrefix: 'Domande su', titleMiddle: 'e', titleSuffix: "l'alternativa open source a Claude Design" },
  ...
  vi: {
    hero: {
      ...
      lead: (skills, systems) =>
        `StoryForge là lựa chọn chính thức, local-first, thay Claude Design. Coding agent bạn đang dùng — Claude Code, Codex, Cursor, Gemini, OpenCode hoặc Qwen — trở thành engine thiết kế với ${skills} skill có thể ghép và ${systems} hệ DESIGN.md di động.`,
    ...
    faqSection: { rule: 'FAQ', answers: 'Câu trả lời chính thức', label: 'FAQ StoryForge', titlePrefix: 'Câu hỏi về', titleMiddle: 'và', titleSuffix: 'lựa chọn mã nguồn mở thay Claude Design' },
  ...
  pl: {
    hero: {
      ...
      lead: (skills, systems) =>
        `StoryForge to oficjalna, local-first alternatywa dla Claude Design. Twój coding agent — Claude Code, Codex, Cursor, Gemini, OpenCode albo Qwen — staje się silnikiem designu z ${skills} kompozycyjnymi skills i ${systems} przenośnymi systemami DESIGN.md.`,
    ...
    faqSection: { rule: 'FAQ', answers: 'Oficjalne odpowiedzi', label: 'FAQ StoryForge', titlePrefix: 'Pytania o', titleMiddle: 'i', titleSuffix: 'open-source alternatywę dla Claude Design' },
  ...
  id: {
    hero: {
      ...
      lead: (skills, systems) =>
        `StoryForge adalah alternatif resmi, local-first, untuk Claude Design. Coding agent yang sudah Anda pakai — Claude Code, Codex, Cursor, Gemini, OpenCode, atau Qwen — menjadi mesin desain dengan ${skills} skill komposable dan ${systems} sistem DESIGN.md portabel.`,
    ...
    faqSection: { rule: 'FAQ', answers: 'Jawaban resmi', label: 'FAQ StoryForge', titlePrefix: 'Pertanyaan tentang', titleMiddle: 'dan', titleSuffix: 'alternatif open source untuk Claude Design' },
  ...
  nl: {
    hero: {
      ...
      lead: (skills, systems) =>
        `StoryForge is het officiële local-first alternatief voor Claude Design. Je bestaande coding agent — Claude Code, Codex, Cursor, Gemini, OpenCode of Qwen — wordt een design-engine met ${skills} combineerbare skills en ${systems} draagbare DESIGN.md-systemen.`,
      star: 'Star op GitHub',
    ...
    faqSection: { rule: 'FAQ', answers: 'Officiële antwoorden', label: 'StoryForge-FAQ', titlePrefix: 'Vragen over', titleMiddle: 'en', titleSuffix: 'het open-source alternatief voor Claude Design' },
  ...
  ar: {
    hero: {
      ...
      lead: (skills, systems) =>
        `StoryForge هو البديل الرسمي المحلي أولاً لـ Claude Design. يتحول coding agent الذي تستخدمه — Claude Code أو Codex أو Cursor أو Gemini أو OpenCode أو Qwen — إلى محرك تصميم مدفوع بـ ${skills} skills قابلة للتركيب و ${systems} أنظمة DESIGN.md قابلة للنقل.`,
    ...
    faqSection: { rule: 'FAQ', answers: 'إجابات رسمية', label: 'أسئلة StoryForge', titlePrefix: 'أسئلة حول', titleMiddle: 'و', titleSuffix: 'البديل مفتوح المصدر لـ Claude Design' },
  ...
  tr: {
    hero: {
      ...
      lead: (skills, systems) =>
        `StoryForge, Claude Design'ın resmi local-first alternatifidir. Zaten kullandığın coding agent — Claude Code, Codex, Cursor, Gemini, OpenCode veya Qwen — ${skills} birleştirilebilir skill ve ${systems} taşınabilir DESIGN.md sistemiyle çalışan bir tasarım motoruna dönüşür.`,
    ...
    faqSection: { rule: 'FAQ', answers: 'Resmi yanıtlar', label: 'StoryForge SSS', titlePrefix: '', titleMiddle: 've', titleSuffix: "Claude Design'ın açık kaynak alternatifi hakkında sorular" },
  ...
  uk: {
    hero: {
      ...
      lead: (skills, systems) =>
        `StoryForge — офіційна local-first альтернатива Claude Design. Ваш coding agent — Claude Code, Codex, Cursor, Gemini, OpenCode або Qwen — стає design engine на базі ${skills} composable skills і ${systems} portable DESIGN.md systems.`,
    ...
    faqSection: { rule: 'FAQ', answers: 'Офіційні відповіді', label: 'FAQ StoryForge українською', titlePrefix: 'Питання про', titleMiddle: 'і', titleSuffix: 'open-source альтернативу Claude Design' },
...
> = {
  ja: {
    ...
    discord: 'Discord',
    rss: 'RSS',
    bottomLeft: '● StoryForge · Apache-2.0 · 2026 / 第 01 巻 / 第 26 号',
  ...
  ko: {
    ...
    discord: 'Discord',
    rss: 'RSS',
    bottomLeft: '● StoryForge · Apache-2.0 · 2026 / 01권 / 26호',
  ...
  de: {
    ...
    discord: 'Discord',
    rss: 'RSS',
    bottomLeft: '● StoryForge · Apache-2.0 · 2026 / Band 01 / Ausgabe Nr. 26',
  ...
  fr: {
    ...
    discord: 'Discord',
    rss: 'RSS',
    bottomLeft: '● StoryForge · Apache-2.0 · 2026 / Volume 01 / Numéro 26',
  ...
  ru: {
    ...
    discord: 'Discord',
    rss: 'RSS',
    bottomLeft: '● StoryForge · Apache-2.0 · 2026 / Том 01 / Выпуск № 26',
  ...
  es: {
    ...
    discord: 'Discord',
    rss: 'RSS',
    bottomLeft: '● StoryForge · Apache-2.0 · 2026 / Volumen 01 / Número 26',
  ...
  'pt-br': {
    ...
    discord: 'Discord',
    rss: 'RSS',
    bottomLeft: '● StoryForge · Apache-2.0 · 2026 / Volume 01 / Edição Nº 26',
  ...
  it: {
    ...
    discord: 'Discord',
    rss: 'RSS',
    bottomLeft: '● StoryForge · Apache-2.0 · 2026 / Volume 01 / Numero 26',
  ...
  vi: {
    ...
    discord: 'Discord',
    rss: 'RSS',
    bottomLeft: '● StoryForge · Apache-2.0 · 2026 / Tập 01 / Số 26',
  ...
  pl: {
    ...
    discord: 'Discord',
    rss: 'RSS',
    bottomLeft: '● StoryForge · Apache-2.0 · 2026 / Tom 01 / Numer 26',
  ...
  id: {
    ...
    discord: 'Discord',
    rss: 'RSS',
    bottomLeft: '● StoryForge · Apache-2.0 · 2026 / Volume 01 / Edisi Nº 26',
  ...
  nl: {
    ...
    discord: 'Discord',
    rss: 'RSS',
    bottomLeft: '● StoryForge · Apache-2.0 · 2026 / Volume 01 / Editie Nº 26',
  ...
  ar: {
    ...
    discord: 'Discord',
    rss: 'RSS',
    bottomLeft: '● StoryForge · Apache-2.0 · 2026 / المجلد 01 / العدد 26',
  ...
  tr: {
    ...
    htmlVideo: 'HTML Video',
    nexuIo: 'nexu.io',
    bottomLeft: '● StoryForge · Apache-2.0 · 2026 / Cilt 01 / Sayı Nº 26',
  ...
  uk: {
    ...
    htmlVideo: 'HTML Video',
    nexuIo: 'nexu.io',
    bottomLeft: '● StoryForge · Apache-2.0 · 2026 / Том 01 / Випуск № 26',
...
> = {
  ja: {
    ...
    downloadAria: 'StoryForge デスクトップアプリをダウンロード',
    download: 'デスクトップをダウンロード',
    columns: { studio: 'スタジオ', library: 'ライブラリ', connect: '接続', openDesign: 'StoryForge' },
  ...
  ko: {
    ...
    downloadAria: 'StoryForge 데스크톱 앱 다운로드',
    download: '데스크톱 다운로드',
    columns: { studio: '스튜디오', library: '라이브러리', connect: '연결', openDesign: 'StoryForge' },
  ...
  de: {
    ...
    download: 'Desktop herunterladen',
    columns: { studio: 'Studio', library: 'Bibliothek', connect: 'Verbinden', openDesign: 'StoryForge' },
  ...
  fr: {
    ...
    downloadAria: "Télécharger l'application desktop StoryForge",
    download: 'Télécharger le desktop',
    columns: { studio: 'Studio', library: 'Bibliothèque', connect: 'Connexion', openDesign: 'StoryForge' },
  ...
  ru: {
    ...
    downloadAria: 'Скачать настольное приложение StoryForge',
    download: 'Скачать desktop',
    columns: { studio: 'Студия', library: 'Библиотека', connect: 'Связь', openDesign: 'StoryForge' },
  ...
  es: {
    ...
    downloadAria: 'Descargar la aplicación de escritorio de StoryForge',
    download: 'Descargar desktop',
    columns: { studio: 'Estudio', library: 'Biblioteca', connect: 'Conectar', openDesign: 'StoryForge' },
  ...
  'pt-br': {
    ...
    downloadAria: 'Baixar o aplicativo desktop do StoryForge',
    download: 'Baixar desktop',
    columns: { studio: 'Estúdio', library: 'Biblioteca', connect: 'Conectar', openDesign: 'StoryForge' },
  ...
  it: {
    ...
    downloadAria: "Scarica l'app desktop di StoryForge",
    download: 'Scarica desktop',
    columns: { studio: 'Studio', library: 'Libreria', connect: 'Connessione', openDesign: 'StoryForge' },
  ...
  vi: {
    ...
    downloadAria: 'Tải ứng dụng desktop StoryForge',
    download: 'Tải desktop',
    columns: { studio: 'Studio', library: 'Thư viện', connect: 'Kết nối', openDesign: 'StoryForge' },
  ...
  pl: {
    ...
    downloadAria: 'Pobierz aplikację desktop StoryForge',
    download: 'Pobierz desktop',
    columns: { studio: 'Studio', library: 'Biblioteka', connect: 'Kontakt', openDesign: 'StoryForge' },
  ...
  id: {
    ...
    downloadAria: 'Unduh aplikasi desktop StoryForge',
    download: 'Unduh desktop',
    columns: { studio: 'Studio', library: 'Pustaka', connect: 'Koneksi', openDesign: 'StoryForge' },
  ...
  nl: {
    ...
    downloadAria: 'Download de StoryForge desktop-app',
    download: 'Desktop downloaden',
    columns: { studio: 'Studio', library: 'Bibliotheek', connect: 'Verbinden', openDesign: 'StoryForge' },
  ...
  ar: {
    ...
    downloadAria: 'تنزيل تطبيق StoryForge لسطح المكتب',
    download: 'تنزيل سطح المكتب',
    columns: { studio: 'الاستوديو', library: 'المكتبة', connect: 'التواصل', openDesign: 'StoryForge' },
  ...
  tr: {
    ...
    downloadAria: 'StoryForge desktop uygulamasını indir',
    download: 'Desktop indir',
    columns: { studio: 'Stüdyo', library: 'Kütüphane', connect: 'Bağlantı', openDesign: 'StoryForge' },
  ...
  uk: {
    ...
    downloadAria: 'Завантажити настільний застосунок StoryForge',
    download: 'Завантажити desktop',
    columns: { studio: 'Студія', library: 'Бібліотека', connect: "Зв'язок", openDesign: 'StoryForge' },
...
const LOCALIZED_HOME_BODY_COPY: Partial<Record<LandingLocaleCode, DeepPartial<HomePageCopy>>> = {
  ja: homeFallbackCopy({
    railRight: 'StoryForge — 第 01 巻 · 第 26 号 · Apache-2.0',
    railLeft: 'Skill · Design System · Agent · BYOK · ローカル優先',
    discordAria: 'StoryForge Discord に参加',
    ...
    heroLead: (skills, systems) =>
      `StoryForge は Claude Design の公式ローカル優先代替です。Claude Code、Codex、Cursor、Gemini、OpenCode、Qwen など既存の coding agent が、${skills} 個の組み合わせ可能な Skill と ${systems} 個のポータブル DESIGN.md システムで動くデザインエンジンになります。`,
    star: 'GitHub で Star',
    download: 'デスクトップをダウンロード',
    plate: '図版 Nº 08',
    composedIn: '構成',
    ...
    officialAria: 'StoryForge の公式ソース',
    officialLabel: '公式ソース',
    officialItems: [
      { label: '公式サイト', value: 'storyforge.ai' },
      { label: 'ソースコード', value: 'nexu-io/storyforge' },
    ...
    about: {
      ...
      caption: '形 · 知覚 · 機械の想像力の研究。（StoryForge, MMXXVI）',
    },
    capabilities: {
    ...
    testimonial: {
      ...
      shoulders: '先人の肩の上に立つ',
      label: '協働者',
      quote: '「StoryForge は曖昧な AI のアイデアを、鋭く、信頼でき、本当に新しい視覚システムへ変えてくれました。」',
...
LOCALIZED_HOME_BODY_COPY.ko = homeFallbackCopy({
  railRight: 'StoryForge — 01권 · 26호 · Apache-2.0',
  railLeft: 'Skill · 디자인 시스템 · Agent · BYOK · 로컬 우선',
  discordAria: 'StoryForge Discord 참여',
  ...
  heroLead: (skills, systems) =>
    `StoryForge은 Claude Design의 공식 로컬 우선 대안입니다. Claude Code, Codex, Cursor, Gemini, OpenCode, Qwen 같은 기존 coding agent가 ${skills}개의 조합 가능한 Skill과 ${systems}개의 portable DESIGN.md 시스템으로 움직이는 디자인 엔진이 됩니다.`,
  star: 'GitHub에서 Star',
  download: '데스크톱 다운로드',
  plate: '도판 Nº 08',
  composedIn: '구성',
  ...
  officialAria: 'StoryForge 공식 출처',
  officialLabel: '공식 출처',
  officialItems: [
    { label: '공식 사이트', value: 'storyforge.ai' },
    { label: '소스 코드', value: 'nexu-io/storyforge' },
  ...
  about: {
    ...
    caption: '형태 · 지각 · 기계적 상상력 연구. (StoryForge, MMXXVI)',
  },
  capabilities: {
  ...
  testimonial: {
    ...
    label: '협업자',
    quote: '“StoryForge은 모호한 AI 아이디어를 날카롭고 믿을 수 있으며 실제로 새로운 시각 시스템으로 바꾸어 주었습니다.”',
...
LOCALIZED_HOME_BODY_COPY.de = homeFallbackCopy({
  railRight: 'StoryForge — Band 01 · Ausgabe Nr. 26 · Apache-2.0',
  railLeft: 'Skills · Systeme · Agents · BYOK · lokal zuerst',
  discordAria: 'StoryForge Discord beitreten',
  ...
  heroLead: (skills, systems) =>
    `StoryForge ist die offizielle lokal zuerst gedachte Alternative zu Claude Design. Dein vorhandener Coding-Agent — Claude Code, Codex, Cursor, Gemini, OpenCode oder Qwen — wird zur Design-Engine mit ${skills} kombinierbaren Skills und ${systems} portablen DESIGN.md-Systemen.`,
  star: 'Auf GitHub sternen',
  download: 'Desktop herunterladen',
  plate: 'Tafel Nr. 08',
  ...
  officialItems: [
    { label: 'Offizielle Website', value: 'storyforge.ai' },
    { label: 'Quellcode', value: 'nexu-io/storyforge' },
  ...
  about: {
    ...
    caption: 'Studien zu Form · Wahrnehmung · maschinischer Vorstellungskraft. (StoryForge, MMXXVI)',
  },
  capabilities: {
  ...
  testimonial: {
    ...
    label: 'Mitwirkende',
    quote: '„StoryForge half uns, vage KI-Ideen in ein visuelles System zu verwandeln, das scharf, glaubwürdig und wirklich neu wirkte.“',
