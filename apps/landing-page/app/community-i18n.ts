...
export const COMMUNITY_LINKS = {
  ...
  discussions: 'https://github.com/nexu-io/storyforge/discussions',
  repo: 'https://github.com/nexu-io/storyforge',
  plugins: 'https://storyforge.ai/plugins/',
  contributing: 'https://github.com/nexu-io/storyforge/blob/main/CONTRIBUTING.md',
  goodFirstIssues:
    'https://github.com/nexu-io/storyforge/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22',
  ambassadorForm:
    'https://docs.google.com/forms/d/e/1FAIpQLSfQryELmEWDLfaAaJqNJatuTQMVfun7bvI7rbt7hLbTrQvYGg/viewform?usp=publish-editor',
  installCommand:
    'curl -sSL https://raw.githubusercontent.com/nexu-io/storyforge/main/.claude/skills/od-contribute/install.sh | bash',
  heroCardImage:
    'https://raw.githubusercontent.com/nexu-io/storyforge/bot-cards/data/cards/dev-kp-eloper-signal-2026-05-26T03-19-40-361Z.png',
} as const;
...
const BOT_LOGINS = new Set([
  'storyforge-bot', 'opendesign-bot', 'nexu-bot', 'storyforge-bot[bot]',
]);
...
const EN: CommunityCopy = {
  hub: {
    title: 'Community — StoryForge',
    desc: 'The StoryForge community: contributors shipping in public, ambassadors hosting local ateliers, and moderators keeping the Discord warm.',
    heroTitle: 'Open design <em>takes shape</em><br/>when you ship it.',
    heroLead:
      'StoryForge is built by people, in public. Skills, DESIGN.md systems, plugins, docs: every commit is a brushstroke. Pick a door below, find your room.',
    cardMetaH: 'Auto-minted on first merge',
    cardMetaS: 'PNG · shared on X',
    cardHeroAlt:
      'StoryForge contributor honor card — @dev-kp-eloper, top 99.9%, Giotto tier',
    cards: [
      {
        ord: 'I',
        title: 'Contributors',
      ...
      },
      {
        ord: 'II',
        title: 'Ambassadors',
        sub: "StoryForge's <em>voice</em> in your city.",
  ...
  contributors: {
    title: 'Contributors — StoryForge',
    desc: 'Contribute to StoryForge: maintainers, weekly and all-time contributor leaderboards, good first issues, and a zero-code path to ship your first piece.',
    heroTitle: 'The hands that <em>ship</em> the work.',
    heroLead:
      "StoryForge is built by people, in public. Skills, DESIGN.md systems, plugins, docs: every commit is a brushstroke. Pick an issue, send a PR, and earn a one-of-one honor card the moment you're merged.",
    showcase: {
      kicker: 'Plugin everything',
      h2: 'StoryForge as a stage. <em>Your work</em> as the show.',
      intro:
      ...
      tenets: [
        ...
        },
        {
          ...
          body: 'The registry at <a href="https://storyforge.ai/plugins/" target="_blank" rel="noopener">storyforge.ai/plugins</a> is only the threshold. From there the strongest pieces are carried outward: to X, to Discord\'s <span class="num">#showcase</span>, to the newsletter, to the video reels. Each handoff widens the room; the world meets your hand.',
        },
        {
          h3: 'Need a <em>first stroke</em>?',
          body: 'Walk the <a href="https://storyforge.ai/plugins/" target="_blank" rel="noopener">plugin registry</a>. The works hung there are kindling for your own. Borrow the spark, then make the piece only your hand could.',
        },
      ],
      pane: {
        kicker: 'The skill',
        ...
        steps: [
          {
            ...
            body: 'Paste the command above into the agent within StoryForge, or into whichever you already keep at hand: Claude Code, Codex, Cursor. It installs itself.',
          },
          {
            h4: 'Wake the skill',
    ...
    maintainers: {
      ...
      intro:
        'Maintainers protect the direction and quality of StoryForge: they review contributions, keep the standard coherent, and make room for more contributors to earn their place in the project.',
      role: 'Maintainer',
      bios: {
        'Nagendhra-web':
          "Nagendhra brings a data engineer's instinct for production truth: find the failure, measure the edge case, and fix it properly. In StoryForge, that shows up in deploy preflight work, asset-bundling hardening, and Windows fixes that make the project feel trustworthy when contributors ship.",
        'Sid-Qin':
          "Sid is the generalist engineer with a designer's eye for detail: the kind of maintainer who notices both the broken CLI path and the crooked interaction affordance. In StoryForge, Sid keeps export flows, plugin actions, Windows shims, MIME handling, and agent plumbing sharp enough for a community to build on.",
      },
    },
    allTime: {
      ...
      intro:
        'A long-running record of talented contributors who keep turning ideas, fixes, and craft into the shared StoryForge standard.',
    ...
    weekly: {
      ...
      intro:
        'A snapshot of sharp contributors landing PRs, improving the product, and making StoryForge feel alive.',
      rankLabel: "This week's leader",
      week: 'Last 7 days',
      handleSuffix: '· leading this week',
      blurbTemplate:
        '{name} is setting the pace this week with {prs} merged PRs and the kind of steady craft that keeps StoryForge moving.',
      statRank: 'Rank',
      statPrs: 'PRs · 7d',
      headContributor: 'Contributor',
      headPrs: 'PRs',
    ...
    issues: {
      ...
      intro:
        'Live from <span class="num">label:&ldquo;good first issue&rdquo;</span> on the StoryForge repo. Comment on an issue to claim it, and a maintainer will assign it within a day.',
  ...
  ambassadors: {
    title: 'Ambassadors — StoryForge',
    desc: "Become an StoryForge ambassador: open a local atelier, host meetups and critiques, and get budget, materials, and a private channel to the core team.",
    heroTitle: "Be StoryForge's <em>voice</em> in your city.",
    heroLead:
    ...
    program: {
      ...
      applyNote:
        'Ambassadors turn StoryForge from a repository into something contributors can meet in a room, with ink on the table and coffee gone cold.',
      cols: [
        {
          n: 'I · Vocation',
    ...
    roster: {
      ...
      intro:
        'Local organizers, creators, and community builders helping StoryForge reach more designers and teams.',
      places: [
  ...
  moderators: {
    title: 'Moderators — StoryForge',
    desc: 'Meet the StoryForge Discord moderators and join the room where AI-native designers ship work, open plugins, break betas, and pull one another unstuck.',
      ...
      cards: [
        {
          ...
          bio: 'From the StoryForge founding team. Hopes the Discord stays a good place to be. Wave at any time, on any question.',
        },
        {
          role: 'Steward of the room',
          bio: 'A practiced hand at Discord and community-tending. Keeps the room warm, the doors open, the conversation flowing. Passionate about StoryForge.',
        },
      ],
