...
> = {
  fr: homeFallbackCopy({
    railRight: 'StoryForge — vol. 01 · no 26 · Apache-2.0',
    railLeft: 'Skills · systèmes · agents · BYOK · local d’abord',
    discordAria: 'Rejoindre le Discord StoryForge',
    ...
    heroLead: (skills, systems) =>
      `StoryForge est l’alternative officielle, local-first, à Claude Design. Votre agent de code — Claude Code, Codex, Cursor, Gemini, OpenCode ou Qwen — devient un moteur de design avec ${skills} skills composables et ${systems} systèmes DESIGN.md portables.`,
    ...
    officialAria: 'Source officielle StoryForge',
    officialLabel: 'Source officielle',
    officialItems: [
      { label: 'Site officiel', value: 'storyforge.ai' },
      { label: 'Code source', value: 'nexu-io/storyforge' },
    ...
    about: {
      ...
      caption: 'Études de forme · perception · imagination machinique. (StoryForge, MMXXVI)',
    },
    capabilities: {
    ...
    testimonial: {
      ...
      quote: '« StoryForge a transformé des idées IA floues en un système visuel net, crédible et réellement nouveau. »',
  ...
  ru: homeFallbackCopy({
    railRight: 'StoryForge — том 01 · выпуск № 26 · Apache-2.0',
    railLeft: 'Skills · системы · агенты · BYOK · local-first',
    discordAria: 'Присоединиться к Discord StoryForge',
    ...
    heroLead: (skills, systems) =>
      `StoryForge — официальная local-first альтернатива Claude Design. Ваш coding agent — Claude Code, Codex, Cursor, Gemini, OpenCode или Qwen — становится дизайн-движком с ${skills} составными skills и ${systems} переносимыми DESIGN.md-системами.`,
    ...
    officialAria: 'Официальный источник StoryForge',
    officialLabel: 'Официальный источник',
    officialItems: [
      { label: 'Официальный сайт', value: 'storyforge.ai' },
      { label: 'Исходный код', value: 'nexu-io/storyforge' },
    ...
    about: {
      ...
      caption: 'Исследования формы · восприятия · машинного воображения. (StoryForge, MMXXVI)',
    },
    capabilities: {
    ...
    testimonial: {
      ...
      label: 'Соавторы',
      quote: '«StoryForge помог превратить расплывчатые AI-идеи в четкую, надежную и действительно новую визуальную систему.»',
  ...
  es: homeFallbackCopy({
    railRight: 'StoryForge — vol. 01 · número 26 · Apache-2.0',
    railLeft: 'Skills · sistemas · agentes · BYOK · local-first',
    discordAria: 'Unirse al Discord de StoryForge',
    ...
    heroLead: (skills, systems) =>
      `StoryForge es la alternativa oficial, local-first, a Claude Design. Tu agente de código — Claude Code, Codex, Cursor, Gemini, OpenCode o Qwen — se convierte en un motor de diseño con ${skills} skills componibles y ${systems} sistemas DESIGN.md portables.`,
    ...
    officialAria: 'Fuente oficial de StoryForge',
    officialLabel: 'Fuente oficial',
    officialItems: [
      { label: 'Sitio oficial', value: 'storyforge.ai' },
      { label: 'Código fuente', value: 'nexu-io/storyforge' },
    ...
    about: {
      ...
      caption: 'Estudios de forma · percepción · imaginación maquínica. (StoryForge, MMXXVI)',
    },
    capabilities: {
    ...
    work: {
      ...
      editedBy: 'Editado por StoryForge',
    ...
    testimonial: {
      ...
      label: 'Colaboradores',
      quote: '«StoryForge convirtió ideas de IA borrosas en un sistema visual nítido, creíble y realmente nuevo.»',
  ...
  'pt-br': homeFallbackCopy({
    railRight: 'StoryForge — vol. 01 · edição nº 26 · Apache-2.0',
    railLeft: 'Skills · sistemas · agentes · BYOK · local-first',
    discordAria: 'Entrar no Discord do StoryForge',
    ...
    heroLead: (skills, systems) =>
      `StoryForge é a alternativa oficial, local-first, ao Claude Design. Seu agente de código — Claude Code, Codex, Cursor, Gemini, OpenCode ou Qwen — vira um motor de design com ${skills} skills componíveis e ${systems} sistemas DESIGN.md portáteis.`,
    ...
    officialAria: 'Fonte oficial do StoryForge',
    officialLabel: 'Fonte oficial',
    officialItems: [
      { label: 'Site oficial', value: 'storyforge.ai' },
      { label: 'Código-fonte', value: 'nexu-io/storyforge' },
    ...
    about: {
      ...
      caption: 'Estudos de forma · percepção · imaginação maquínica. (StoryForge, MMXXVI)',
    },
    capabilities: {
      rule: 'Capacidades · skills · sistemas',
    ...
    testimonial: {
      ...
      label: 'Colaboradores',
      quote: '“StoryForge transformou ideias vagas de IA em um sistema visual nítido, confiável e realmente novo.”',
  ...
  it: homeFallbackCopy({
    railRight: 'StoryForge — vol. 01 · numero 26 · Apache-2.0',
    railLeft: 'Skill · sistemi · agenti · BYOK · local-first',
    discordAria: 'Entra nel Discord di StoryForge',
    ...
    heroLead: (skills, systems) =>
      `StoryForge è l’alternativa ufficiale, local-first, a Claude Design. Il tuo agente di codice — Claude Code, Codex, Cursor, Gemini, OpenCode o Qwen — diventa un motore di design con ${skills} skill componibili e ${systems} sistemi DESIGN.md portabili.`,
    ...
    officialAria: 'Fonte ufficiale StoryForge',
    officialLabel: 'Fonte ufficiale',
    officialItems: [
      { label: 'Sito ufficiale', value: 'storyforge.ai' },
      { label: 'Codice sorgente', value: 'nexu-io/storyforge' },
    ...
    about: {
      ...
      caption: 'Studi di forma · percezione · immaginazione macchinica. (StoryForge, MMXXVI)',
    },
    capabilities: {
    ...
    testimonial: {
      ...
      label: 'Collaboratori',
      quote: '“StoryForge ha trasformato idee AI vaghe in un sistema visivo nitido, credibile e davvero nuovo.”',
  ...
  vi: homeFallbackCopy({
    railRight: 'StoryForge — tập 01 · số 26 · Apache-2.0',
    railLeft: 'Skill · hệ thống · agent · BYOK · ưu tiên local',
    discordAria: 'Tham gia Discord StoryForge',
    ...
    heroLead: (skills, systems) =>
      `StoryForge là lựa chọn chính thức, ưu tiên local, thay Claude Design. Agent viết code bạn đang dùng — Claude Code, Codex, Cursor, Gemini, OpenCode hoặc Qwen — trở thành engine thiết kế với ${skills} skill có thể ghép và ${systems} hệ DESIGN.md di động.`,
    ...
    officialAria: 'Nguồn chính thức của StoryForge',
    officialLabel: 'Nguồn chính thức',
    officialItems: [
      { label: 'Trang chính thức', value: 'storyforge.ai' },
      { label: 'Mã nguồn', value: 'nexu-io/storyforge' },
    ...
    about: {
      ...
      caption: 'Nghiên cứu hình thái · tri giác · tưởng tượng máy. (StoryForge, MMXXVI)',
    },
    capabilities: {
    ...
    work: {
      ...
      editedBy: 'Biên tập bởi StoryForge',
    ...
    testimonial: {
      ...
      label: 'Cộng tác viên',
      quote: '“StoryForge biến ý tưởng AI mơ hồ thành một hệ thị giác sắc nét, đáng tin và thật sự mới.”',
  ...
  pl: homeFallbackCopy({
    railRight: 'StoryForge — tom 01 · wydanie nr 26 · Apache-2.0',
    railLeft: 'Skills · systemy · agenci · BYOK · lokalnie najpierw',
    discordAria: 'Dołącz do Discorda StoryForge',
    ...
    heroLead: (skills, systems) =>
      `StoryForge to oficjalna, lokalna z założenia alternatywa dla Claude Design. Twój agent do kodu — Claude Code, Codex, Cursor, Gemini, OpenCode albo Qwen — staje się silnikiem designu z ${skills} kompozycyjnymi skills i ${systems} przenośnymi systemami DESIGN.md.`,
    ...
    officialAria: 'Oficjalne źródło StoryForge',
    officialLabel: 'Oficjalne źródło',
    officialItems: [
      { label: 'Oficjalna strona', value: 'storyforge.ai' },
      { label: 'Kod źródłowy', value: 'nexu-io/storyforge' },
    ...
    about: {
      ...
      caption: 'Studia formy · percepcji · wyobraźni maszynowej. (StoryForge, MMXXVI)',
    },
    capabilities: {
    ...
    testimonial: {
      ...
      quote: '„StoryForge zmienił niejasne idee AI w ostry, wiarygodny i naprawdę nowy system wizualny.”',
  ...
  id: homeFallbackCopy({
    railRight: 'StoryForge — vol. 01 · edisi nº 26 · Apache-2.0',
    railLeft: 'Skill · sistem · agent · BYOK · local-first',
    discordAria: 'Bergabung ke Discord StoryForge',
    ...
    heroLead: (skills, systems) =>
      `StoryForge adalah alternatif resmi, local-first, untuk Claude Design. Agent coding yang sudah Anda pakai — Claude Code, Codex, Cursor, Gemini, OpenCode, atau Qwen — menjadi mesin desain dengan ${skills} skill komposable dan ${systems} sistem DESIGN.md portabel.`,
    ...
    officialAria: 'Sumber resmi StoryForge',
    officialLabel: 'Sumber resmi',
    officialItems: [
      { label: 'Situs resmi', value: 'storyforge.ai' },
      { label: 'Kode sumber', value: 'nexu-io/storyforge' },
    ...
    about: {
      ...
      caption: 'Studi bentuk · persepsi · imajinasi mesin. (StoryForge, MMXXVI)',
    },
    capabilities: {
    ...
    testimonial: {
      ...
      label: 'Kolaborator',
      quote: '“StoryForge mengubah ide AI yang samar menjadi sistem visual yang tajam, dapat dipercaya, dan benar-benar baru.”',
  ...
  nl: homeFallbackCopy({
    railRight: 'StoryForge — deel 01 · nummer 26 · Apache-2.0',
    railLeft: 'Skills · systemen · agents · BYOK · local-first',
    discordAria: 'Word lid van StoryForge Discord',
    ...
    heroLead: (skills, systems) =>
      `StoryForge is het officiële local-first alternatief voor Claude Design. Je bestaande code-agent — Claude Code, Codex, Cursor, Gemini, OpenCode of Qwen — wordt een design-engine met ${skills} combineerbare skills en ${systems} draagbare DESIGN.md-systemen.`,
    ...
    officialAria: 'Officiële bron van StoryForge',
    officialLabel: 'Officiële bron',
    officialItems: [
      { label: 'Officiële site', value: 'storyforge.ai' },
      { label: 'Broncode', value: 'nexu-io/storyforge' },
    ...
    about: {
      ...
      caption: 'Studies naar vorm · perceptie · machinale verbeelding. (StoryForge, MMXXVI)',
    },
    capabilities: {
    ...
    testimonial: {
      ...
      label: 'Samenwerkers',
      quote: '“StoryForge veranderde vage AI-ideeën in een scherp, geloofwaardig en echt nieuw visueel systeem.”',
  ...
  ar: homeFallbackCopy({
    railRight: 'StoryForge — المجلد 01 · العدد 26 · Apache-2.0',
    railLeft: 'Skills · أنظمة · Agents · BYOK · محلي أولاً',
    discordAria: 'الانضمام إلى Discord الخاص بـ StoryForge',
    ...
    heroLead: (skills, systems) =>
      `StoryForge هو البديل الرسمي المحلي أولاً لـ Claude Design. يتحول agent البرمجة الذي تستخدمه — Claude Code أو Codex أو Cursor أو Gemini أو OpenCode أو Qwen — إلى محرك تصميم يعتمد على ${skills} skills قابلة للتركيب و ${systems} أنظمة DESIGN.md قابلة للنقل.`,
    ...
    officialAria: 'المصدر الرسمي لـ StoryForge',
    officialLabel: 'المصدر الرسمي',
    officialItems: [
      { label: 'الموقع الرسمي', value: 'storyforge.ai' },
      { label: 'الكود المصدري', value: 'nexu-io/storyforge' },
    ...
    about: {
      ...
      caption: 'دراسات في الشكل · الإدراك · الخيال الآلي. (StoryForge, MMXXVI)',
    },
    capabilities: {
    ...
    testimonial: {
      ...
      label: 'المتعاونون',
      quote: '“حوّل StoryForge أفكار AI الغامضة إلى نظام بصري حاد وموثوق وجديد فعلاً.”',
    ...
    faqSection: {
      ...
      label: 'أسئلة StoryForge الشائعة',
  ...
  tr: homeFallbackCopy({
    railRight: 'StoryForge — cilt 01 · sayı nº 26 · Apache-2.0',
    railLeft: 'Skill · sistem · agent · BYOK · local-first',
    discordAria: 'StoryForge Discord’a katıl',
    ...
    heroLead: (skills, systems) =>
      `StoryForge, Claude Design’ın resmi local-first alternatifidir. Kullandığın coding agent — Claude Code, Codex, Cursor, Gemini, OpenCode veya Qwen — ${skills} birleştirilebilir skill ve ${systems} taşınabilir DESIGN.md sistemiyle bir tasarım motoruna dönüşür.`,
    ...
    officialAria: 'StoryForge resmi kaynağı',
    officialLabel: 'Resmi kaynak',
    officialItems: [
      { label: 'Resmi site', value: 'storyforge.ai' },
      { label: 'Kaynak kod', value: 'nexu-io/storyforge' },
    ...
    about: {
      ...
      caption: 'Form · algı · makine imgelemi çalışmaları. (StoryForge, MMXXVI)',
    },
    capabilities: {
    ...
    work: {
      ...
      editedBy: 'StoryForge editörlüğü',
    ...
    testimonial: {
      ...
      label: 'İşbirlikçiler',
      quote: '“StoryForge belirsiz AI fikirlerini keskin, güvenilir ve gerçekten yeni bir görsel sisteme dönüştürdü.”',
  ...
  uk: homeFallbackCopy({
    railRight: 'StoryForge — том 01 · випуск № 26 · Apache-2.0',
    railLeft: 'Skills · системи · агенти · BYOK · local-first',
    discordAria: 'Приєднатися до Discord StoryForge',
    ...
    heroLead: (skills, systems) =>
      `StoryForge — офіційна local-first альтернатива Claude Design. Ваш coding agent — Claude Code, Codex, Cursor, Gemini, OpenCode або Qwen — стає design engine із ${skills} composable skills та ${systems} portable DESIGN.md systems.`,
    ...
    officialAria: 'Офіційне джерело StoryForge',
    officialLabel: 'Офіційне джерело',
    officialItems: [
      { label: 'Офіційний сайт', value: 'storyforge.ai' },
      { label: 'Вихідний код', value: 'nexu-io/storyforge' },
    ...
    about: {
      ...
      caption: 'Дослідження форми · сприйняття · машинної уяви. (StoryForge, MMXXVI)',
    },
    capabilities: {
    ...
    testimonial: {
      ...
      label: 'Співтворці',
      quote: '«StoryForge допоміг перетворити нечіткі AI-ідеї на гостру, надійну й справді нову візуальну систему.»',
