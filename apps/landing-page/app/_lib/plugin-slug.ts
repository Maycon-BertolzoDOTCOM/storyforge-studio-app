...
//
// The marketing site must NOT import `@storyforge-app/contracts` (see
...
// `storyforge/Hero Deck` -> `hero-deck`. This is what `/plugins/[slug]/` uses.
...
// `storyforge/Hero Deck` -> `storyforge/hero-deck`.
