...
const en: HomeCopy = {
  ...
  aboutCaptionCredit: '(StoryForge, MMXXVI)',
  ...
  testimonialQuotePre: '“StoryForge helped us turn vague',
...
const zhCN: Partial<HomeCopy> = {
  ...
  testimonialQuotePre: '“StoryForge 帮我们把模糊的',
...
const ja: Partial<HomeCopy> = {
  ...
  testimonialQuotePre: '「StoryForge は私たちの曖昧な',
...
const ko: Partial<HomeCopy> = {
  ...
  testimonialQuotePre: '"StoryForge 은 우리의 모호한',
...
const zhTW: Partial<HomeCopy> = {
  ...
  testimonialLabel: '合作者 · Nº 06',
  testimonialQuotePre: '「StoryForge 幫我們把模糊的',
  testimonialQuoteEm1: 'AI 想法',
...
const de: Partial<HomeCopy> = {
  ...
  testimonialQuotePre: '„StoryForge hat uns geholfen, vage',
...
const fr: Partial<HomeCopy> = {
  ...
  testimonialQuotePre: '« StoryForge nous a aidés à transformer de vagues',
...
const esES: Partial<HomeCopy> = {
  ...
  testimonialQuotePre: '«StoryForge nos ayudó a convertir',
...
const ptBR: Partial<HomeCopy> = {
  ...
  testimonialLabel: 'Colaboradores · Nº 06',
  testimonialQuotePre: '"O StoryForge nos ajudou a transformar',
