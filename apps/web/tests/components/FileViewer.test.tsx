...
describe('applyInspectOverridesToSource', () => {
  ...
  // Regression for nexu-io/storyforge#362: if a source file has more than
  ...
  // Regression for nexu-io/storyforge#362: the splicer must be HTML-aware
  ...
  // Regression for nexu-io/storyforge#362: the splicer must look at real
...
describe('serializeInspectOverrides', () => {
  ...
  // Regression for nexu-io/storyforge#362: standard deck slides ship as
...
// Regression for nexu-io/storyforge#362: the host owns the inspect override
...
describe('parseInspectOverridesFromSource', () => {
  ...
  // Regression for nexu-io/storyforge#362: hydration must require an
