...
import type { DesignSystemSummary } from '@storyforge-app/contracts';
...
describe('DesignSystemsTab surface filtering', () => {
  it('scopes surface pill counts to the selected style category', () => {
    // Regression: nexu-io/storyforge#2062 — surface chips kept showing the
  ...
  it('keeps the style category when a surface chip refines within it', () => {
    // Regression: nexu-io/storyforge#2062 — clicking a surface chip reset
