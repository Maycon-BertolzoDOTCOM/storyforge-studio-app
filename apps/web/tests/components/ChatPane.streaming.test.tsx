  ...
  AssistantMessage: ({
    ...
    <>
      ...
      {onShareToOpenDesign ? (
        ...
        >
          {shareToOpenDesignBusy ? 'Preparing package…' : 'Share to StoryForge'}
        </button>
      ) : null}
    </>
  ),
...
- A clear DESIGN.md with all generated rules.`,
  ...
  it('keeps Share to StoryForge busy on the assistant turn that started packaging', () => {
    ...
    rerender(
      <ChatPane
        ...
        messages={[
          ...initialMessages,
          { id: 'user-2', role: 'user', content: 'Share to StoryForge', createdAt: 4 },
          {
            id: 'assistant-2',
            role: 'assistant',
            content: '',
