...
export const zhCN: Dict = {
  ...
  'settings.updatePreviewLabel': '更新状态预览',
  'settings.updatePreviewActual': '实际开发状态',
  'settings.updatePreviewIdle': '未检查',
  'settings.updatePreviewChecking': '检查中',
  'settings.updatePreviewUpToDate': '已是最新版本',
  'settings.updatePreviewAvailable': '发现新版本',
  'settings.updatePreviewDownloading': '下载中',
  'settings.updatePreviewDownloaded': '已准备安装',
  'settings.updatePreviewInstalling': '安装中',
  'settings.updatePreviewError': '检查失败',
  'settings.updatePreviewUnsupported': '不支持环境',
