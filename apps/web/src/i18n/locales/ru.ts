...
export const ru: Dict = {
  ...
  'settings.updatePreviewLabel': 'Предпросмотр обновления',
  'settings.updatePreviewActual': 'Реальный статус dev-сборки',
  'settings.updatePreviewIdle': 'Не проверено',
  'settings.updatePreviewChecking': 'Проверка',
  'settings.updatePreviewUpToDate': 'Последняя версия',
  'settings.updatePreviewAvailable': 'Новая версия',
  'settings.updatePreviewDownloading': 'Загрузка',
  'settings.updatePreviewDownloaded': 'Готово к установке',
  'settings.updatePreviewInstalling': 'Установка',
  'settings.updatePreviewError': 'Ошибка проверки',
  'settings.updatePreviewUnsupported': 'Не поддерживается',
