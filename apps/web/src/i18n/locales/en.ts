...
export const en: Dict = {
  ...
  'chat.amrCard.switchBody': 'Switch to StoryForge — no API key setup needed. After you sign in, authorize, and top up, this run retries automatically.',
  ...
  'chat.amrCard.switchCta': 'Switch to StoryForge & retry',
  'chat.amrError.authMessage': 'Your StoryForge account isn\'t authorized yet. Authorize it and this run retries automatically.',
  'chat.amrError.balanceMessage': 'Your StoryForge balance has run out. Top up to keep this run going.',
  ...
  'chat.runError.signInMessage.amr': 'The StoryForge agent isn\'t signed in yet — sign in to start using it.',
  'chat.runError.signInMessage.other': '{agent} isn\'t signed in. Check its sign-in status locally. We recommend the StoryForge agent — steadier and better value.',
  ...
  'settings.welcomeTitle': 'Welcome to StoryForge',
  'settings.welcomeSubtitle': '',
  'settings.onboardingCreateTitle': 'Start from a brief',
  'settings.onboardingCreateBody': 'Describe the site, app, deck, image, or video you want. StoryForge will create a project and keep the work editable.',
  ...
  'settings.onboardingMemoryCalloutBody': 'These answers seed your Memory profile. StoryForge reuses it on every task — and keeps learning as you work.',
  ...
  'settings.onboardingAmrModelSourceLabel': 'StoryForge',
  ...
  'settings.onboardingGateTooltipAmr': 'The next steps run on AI — sign in to StoryForge to continue.',
  ...
  'settings.agentInstall.pathHint': 'If you installed a CLI with npm or Homebrew and it still shows as not installed, ensure the tool\'s bin directory is on the PATH the StoryForge daemon inherits (Terminal vs GUI apps can differ on macOS). See QUICKSTART.md (section "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Open Install or Docs for your preferred agent.',
  'settings.agentInstall.stepAuth': 'Authenticate with the vendor CLI (sign in or add API credentials) before returning to StoryForge.',
  ...
  'settings.amrAccountStatus': 'StoryForge account status',
  ...
  'settings.mcpServerHint': 'Expose StoryForge as an MCP server for your coding agent.',
  ...
  'settings.privacyHint': 'What data is shared with the StoryForge team',
  'settings.privacyConsentKicker': 'Help us improve StoryForge',
  'settings.privacyConsentLead': 'StoryForge can share usage data with our team to help us improve. This includes:',
  ...
  'settings.updateQuitFailed': 'The installer opened, but StoryForge could not quit automatically.',
  ...
  'settings.mcpHint': 'Let coding agents (Cursor, Claude Code, VS Code…) read your StoryForge projects directly.',
  'settings.mcpDaemonError': 'Couldn\'t reach the local daemon to resolve install paths ({error}). Make sure StoryForge is running, then reopen this panel.',
  'settings.mcpBuildDaemon': 'Build the daemon first.',
  'settings.mcpNodeMissing': 'Node binary is missing.',
  'settings.mcpBuildHint': 'apps/daemon/dist/cli.js is missing. Run `pnpm --filter @storyforge-app/daemon build` and refresh.',
  ...
  'settings.mcpCapabilityDefault': 'Default to the project and file you have open in StoryForge, so you can say "build this in my app" without re-stating which design.',
  'settings.mcpRunningNote': 'StoryForge must be running for MCP tool calls to succeed. If you started your coding agent before opening StoryForge, restart the agent so it can reach the live daemon.',
  ...
  'entry.discordAria': 'Join the StoryForge Discord',
  'entry.discordAriaWithOnline': 'Join the StoryForge Discord - {online}',
  ...
  'entry.followLinkedinLabel': 'Follow StoryForge on LinkedIn',
  'entry.followXiaohongshuLabel': 'Follow StoryForge on Xiaohongshu',
  ...
  'homeHero.chip.createPluginHint': 'Author a reusable StoryForge plugin and add it to My plugins.',
  ...
  'handoff.amrWebsite': 'Visit StoryForge',
  ...
  'handoff.promptIntro': 'Continue from this local StoryForge project folder:',
  ...
  'designSystemPicker.noPreview': 'No preview page. StoryForge Systems to view the full preview.',
  ...
  'pluginsHome.subtitle': 'Ready-to-use StoryForge workflows bundled with this runtime. Pick one to load a starter prompt, or browse the registry for more.',
  'pluginsHome.browseRegistry': 'Browse registry',
  'pluginsHome.count': '{filtered} of {total}',
  'pluginsHome.loadingCatalog': 'Loading catalog…',
  'pluginsHome.emptyCatalog': 'Catalog is empty. Bundled plugins ship with StoryForge and should appear here automatically — try restarting the daemon if this persists.',
  ...
  'pluginCard.contributeAria': 'Contribute {title} to StoryForge',
  'pluginCard.contributeTitle': 'Contribute plugin to StoryForge with a pull request',
  'skillPluginCandidate.createForMe': 'Create plugin/template',
  'skillPluginCandidate.contributeToMain': 'Contribute to storyforge',
  'skillPluginCandidate.repoDescription': 'This repo looks like it could work as a plugin.',
  'integrations.kicker': 'Integration',
  'integrations.lede': 'Connect external systems, bring MCP tools into your agent loop, and use StoryForge from other IDEs, scripts, and automations.',
  ...
  'mcpClient.daemonError': 'Could not reach the local daemon. Make sure StoryForge is running, then reopen this panel.',
  'mcpClient.saveFailed': 'Save failed. Check that the daemon is running and try again.',
  'useEverywhere.modalAria': 'Use StoryForge everywhere',
  'useEverywhere.modalTitle': 'Use StoryForge everywhere',
  'useEverywhere.modalSubtitle': 'Drop StoryForge into any IDE, agent, or script — CLI, HTTP, MCP, and Skills. Use “Copy guide for an agent” and paste into Claude Code, Codex, Cursor, openclaw, or hermes to set up everything.',
  ...
  'useEverywhere.section.overview.heading': 'StoryForge works wherever your agent works',
  'useEverywhere.section.overview.intro': 'StoryForge is more than a window — it is a local privileged daemon (`od`) plus a Skills + Design-Systems + Atoms registry. Once it is running on your machine, any code agent (Claude Code, Codex, Cursor, OpenCode/openclaw, Hermes, your own script) can drive generations, inspect projects, and produce design artifacts through four interchangeable surfaces.',
  'useEverywhere.section.overview.bullet1': 'CLI — `od <command>` for headless scripts, CI, and shell automation.',
  'useEverywhere.section.overview.bullet2': 'MCP server — wires StoryForge as a Model Context Protocol server so any MCP-capable agent can list skills, run scenarios, and read artifacts.',
  ...
  'useEverywhere.section.overview.bullet4': 'Skills — drop-in `SKILL.md` packs (Claude-compatible) that any agent already on your PATH can invoke without StoryForge at all.',
  ...
  'useEverywhere.section.overview.footer': 'The daemon writes to `./.od/` (project-local) by default. Set `OD_DATA_DIR=~/.storyforge` to share data across projects.',
  'useEverywhere.section.cli.tab': 'CLI · od',
  'useEverywhere.section.cli.heading': 'Drive StoryForge from any shell',
  ...
  'useEverywhere.section.mcp.heading': 'Expose StoryForge as an MCP server to any coding agent',
  'useEverywhere.section.mcp.intro': 'StoryForge ships with a Model Context Protocol server (`od mcp`) that lets any MCP-capable client — Cursor, Claude Code, Antigravity, VS Code Copilot Chat, openclaw, hermes — discover StoryForge tools (list skills, render previews, generate media, run plugins) without shelling out manually. The daemon publishes a ready-to-paste install snippet via `GET /api/mcp/install-info` for each major client.',
  ...
  'useEverywhere.section.mcp.footer': 'In the StoryForge app, open Settings → Integrations to copy a client-specific install command (Cursor, Claude Code, Antigravity, VS Code) instead of editing JSON by hand.',
  'useEverywhere.section.http.tab': 'HTTP API',
  'useEverywhere.section.http.heading': 'Same REST + SSE surface the web UI uses',
  'useEverywhere.section.http.intro': 'The local daemon serves an HTTP API at `http://127.0.0.1:7456` (port configurable). Every endpoint the web UI calls is also fair game for your scripts. Streaming endpoints (chat turns, project runs) emit Server-Sent Events with the contract types in `@storyforge-app/contracts`.',
  ...
  'useEverywhere.section.http.footer': 'Pure TypeScript types for every request/response live in `@storyforge-app/contracts` — import them in your script for full autocomplete without wiring a generator.',
  'useEverywhere.section.skills.tab': 'Skills & headless',
  'useEverywhere.section.skills.heading': 'Drop-in Skills for any agent — even without StoryForge running',
  'useEverywhere.section.skills.intro': 'A Skill is a directory with a Claude-compatible `SKILL.md` (YAML front-matter + body). StoryForge extends the format with the `od:` namespace (`mode`, `preview`, `design_system`, `inputs`, …) so the same artifact can be used both inside StoryForge and by a vanilla agent like Claude Code, Codex, openclaw, or hermes. Discovery follows a precedence chain so projects can override their own skills.',
  ...
  'useEverywhere.section.skills.snippet1': 'Minimal SKILL.md (Claude-compatible front matter + StoryForge extras)',
  ...
  'entry.githubStarAria': 'Star StoryForge on GitHub',
  ...
  'newproj.locationDefault': 'StoryForge projects',
  ...
  'socialShare.openDesignSection': 'Share StoryForge',
  'socialShare.openDesignTitle': 'StoryForge on GitHub',
  'socialShare.openDesignText': 'StoryForge is an open-source workspace for creating, editing, deploying, and handing off design artifacts.',
  ...
  'socialShare.projectText': 'Built with StoryForge: {title}. View the deployed artifact and star the repo: {repo}',
  'socialShare.projectCopyText': 'Built with StoryForge: {title}\n{url}\nStoryForge repo: {repo}',
  ...
  'brandEnrichment.body': "StoryForge will run a deeper extraction in the background, apply the right design-system skills automatically, and update this system in place. This can take 10-20 minutes; you can keep working.",
  ...
  'chat.activeFilePlaceholder': 'Ask StoryForge to change {file}...',
  ...
  'chat.mode.design.solves': 'Use it when you want StoryForge to generate files, update the workspace, or turn a brief into multimodal deliverables.',
  ...
  'preview.errorBody': 'The example HTML failed to fetch. Make sure StoryForge is running and try again.',
  'preview.retry': 'Retry',
  ...
  'designFiles.usefulInfoTip7': 'Enjoying StoryForge? Star us on GitHub.',
  ...
  'designFiles.usefulInfoTip18': 'Subscribe to StoryForge on YouTube for tutorials and demos.',
  'designFiles.usefulInfoTip19': 'Follow StoryForge on LinkedIn for product news.',
  'designFiles.usefulInfoTip20': 'Follow StoryForge on Xiaohongshu for tips and inspiration.',
  ...
  'assistant.shareToOpenDesign': 'Share to StoryForge',
  ...
  'pet.tabBuiltInHint': 'Curated companions bundled with StoryForge — pick one and adopt.',
  ...
  'pet.codexBundledTitle': 'Ships with StoryForge — no download needed.',
  ...
  'settings.projectLocationsDescription': 'Add work bases that can contain multiple StoryForge project folders. New projects are saved as one folder inside the selected base.',
  ...
  'updater.availableBody': 'StoryForge {version} is available. It will download before the installer can open.',
  ...
  'updater.installerOpenBody': 'The installer is open. StoryForge is quitting so you can finish the update.',
  ...
  'updater.quitButton': 'Quit StoryForge',
  'updater.quitFailedBody': 'The installer is open, but StoryForge could not quit. Quit StoryForge before replacing the app.',
  'updater.quitFailedTitle': 'Could not quit',
  'updater.quitting': 'Quitting...',
  'updater.ready': 'Update ready',
  'updater.readyGeneric': 'A new version is ready. StoryForge will close and open the installer.',
  'updater.readyVersion': 'StoryForge {version} is ready. StoryForge will close and open the installer.',
  ...
  'dsManager.createBody': 'Teach StoryForge your brand, product, code, assets, and design references.',
  ...
  'settings.customInstructionsDesc': 'Fixed instructions StoryForge follows in every chat. These are not saved memories; use Memory for facts, preferences, and project context.',
  ...
  'brand.librarySubtitle': 'Teach StoryForge your design systems — extract one from a website, then apply it in any chat.',
  ...
  'onboarding.buildBody': 'StoryForge turns your brand into a reusable design system — then keeps everything you build on-brand and consistent.',
