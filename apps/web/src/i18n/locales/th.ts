...
export const th: Dict = {
  ...
  'settings.updatePreviewLabel': 'ตัวอย่างสถานะอัปเดต',
  'settings.updatePreviewActual': 'สถานะพัฒนาจริง',
  'settings.updatePreviewIdle': 'ยังไม่ตรวจสอบ',
  'settings.updatePreviewChecking': 'กำลังตรวจสอบ',
  'settings.updatePreviewUpToDate': 'เวอร์ชันล่าสุด',
  'settings.updatePreviewAvailable': 'เวอร์ชันใหม่',
  'settings.updatePreviewDownloading': 'กำลังดาวน์โหลด',
  'settings.updatePreviewDownloaded': 'พร้อมติดตั้ง',
  'settings.updatePreviewInstalling': 'กำลังติดตั้ง',
  'settings.updatePreviewError': 'ตรวจสอบล้มเหลว',
  'settings.updatePreviewUnsupported': 'ไม่รองรับ',
