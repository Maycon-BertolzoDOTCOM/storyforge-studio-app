...
const TOGGLE_EVENT = 'storyforge:critique-theater-toggle';
 ...
 *
 * Source of truth is the existing `storyforge:config` localStorage
 ...
 *   2. A same-tab `storyforge:critique-theater-toggle` CustomEvent so
