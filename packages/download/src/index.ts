...
import { atomicCopyFile, isProcessAlive, pathContains, removePathBestEffort } from "@storyforge-app/platform";

const STORE_SENTINEL = ".storyforge-download-root.json";
const STATE_DIR = ".state";
const PARTIAL_DIR = ".partial";
const LOCK_DIR = ".locks";
const STORE_SCHEMA_VERSION = 1;
const MANIFEST_SCHEMA_VERSION = 1;
const STORE_KIND = "storyforge-managed-download-root";
const MANIFEST_KIND = "storyforge-managed-download";
